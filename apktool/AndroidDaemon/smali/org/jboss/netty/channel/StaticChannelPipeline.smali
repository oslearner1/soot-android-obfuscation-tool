...
.field private final contexts:[Lorg/jboss/netty/channel/s;
...
.method public varargs constructor <init>([Lorg/jboss/netty/channel/ChannelHandler;)V
    ...
    new-array v2, v0, [Lorg/jboss/netty/channel/s;
    ...
    iput-object v2, p0, Lorg/jboss/netty/channel/StaticChannelPipeline;->contexts:[Lorg/jboss/netty/channel/s;
    ...
    new-instance v6, Lorg/jboss/netty/channel/s;

    invoke-direct {v6, p0, v3, v5, v4}, Lorg/jboss/netty/channel/s;-><init>(Lorg/jboss/netty/channel/StaticChannelPipeline;ILjava/lang/String;Lorg/jboss/netty/channel/ChannelHandler;)V
...
.method public get(Ljava/lang/String;)Lorg/jboss/netty/channel/ChannelHandler;
    ...
    check-cast v0, Lorg/jboss/netty/channel/s;
    ...
    :cond_0
    invoke-virtual {v0}, Lorg/jboss/netty/channel/s;->getHandler()Lorg/jboss/netty/channel/ChannelHandler;
...
.method getActualDownstreamContext(I)Lorg/jboss/netty/channel/s;
    .locals 2

    :goto_0
    if-ltz p1, :cond_1

    iget-object v0, p0, Lorg/jboss/netty/channel/StaticChannelPipeline;->contexts:[Lorg/jboss/netty/channel/s;

    aget-object v0, v0, p1

    invoke-virtual {v0}, Lorg/jboss/netty/channel/s;->canHandleDownstream()Z
...
.method getActualUpstreamContext(I)Lorg/jboss/netty/channel/s;
    .locals 2
    ...
    invoke-virtual {v0}, Lorg/jboss/netty/channel/s;->canHandleUpstream()Z
...
.method public getContext(Ljava/lang/Class;)Lorg/jboss/netty/channel/ChannelHandlerContext;
    ...
    :cond_0
    iget-object v2, p0, Lorg/jboss/netty/channel/StaticChannelPipeline;->contexts:[Lorg/jboss/netty/channel/s;
...
.method public getLast()Lorg/jboss/netty/channel/ChannelHandler;
    ...
    iget-object v1, p0, Lorg/jboss/netty/channel/StaticChannelPipeline;->contexts:[Lorg/jboss/netty/channel/s;
...
.method public getNames()Ljava/util/List;
    ...
    invoke-virtual {v4}, Lorg/jboss/netty/channel/s;->getName()Ljava/lang/String;
...
.method public sendDownstream(Lorg/jboss/netty/channel/ChannelEvent;)V
    ...
    invoke-virtual {p0, v0}, Lorg/jboss/netty/channel/StaticChannelPipeline;->getActualDownstreamContext(I)Lorg/jboss/netty/channel/s;
    ...
    :cond_0
    invoke-virtual {p0, v0, p1}, Lorg/jboss/netty/channel/StaticChannelPipeline;->sendDownstream(Lorg/jboss/netty/channel/s;Lorg/jboss/netty/channel/ChannelEvent;)V

    goto :goto_0
.end method

.method sendDownstream(Lorg/jboss/netty/channel/s;Lorg/jboss/netty/channel/ChannelEvent;)V
    .locals 2
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p1}, Lorg/jboss/netty/channel/s;->getHandler()Lorg/jboss/netty/channel/ChannelHandler;
...
.method public sendUpstream(Lorg/jboss/netty/channel/ChannelEvent;)V
    ...
    invoke-virtual {p0, v0}, Lorg/jboss/netty/channel/StaticChannelPipeline;->getActualUpstreamContext(I)Lorg/jboss/netty/channel/s;
    ...
    :cond_0
    invoke-virtual {p0, v0, p1}, Lorg/jboss/netty/channel/StaticChannelPipeline;->sendUpstream(Lorg/jboss/netty/channel/s;Lorg/jboss/netty/channel/ChannelEvent;)V

    goto :goto_0
.end method

.method sendUpstream(Lorg/jboss/netty/channel/s;Lorg/jboss/netty/channel/ChannelEvent;)V
    .locals 1
...
.method public toMap()Ljava/util/Map;
    ...
    invoke-virtual {v4}, Lorg/jboss/netty/channel/s;->getHandler()Lorg/jboss/netty/channel/ChannelHandler;
