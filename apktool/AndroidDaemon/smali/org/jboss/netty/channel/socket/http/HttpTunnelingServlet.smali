...
.method private static read(Ljava/io/PushbackInputStream;)Lorg/jboss/netty/buffer/ChannelBuffer;
    ...
    invoke-virtual {p0, v0}, Ljava/io/PushbackInputStream;->read([B)I
    ...
    invoke-static {v0, v2, v1}, Lorg/jboss/netty/buffer/ChannelBuffers;->wrappedBuffer([BII)Lorg/jboss/netty/buffer/ChannelBuffer;
...
.method protected service(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V
    ...
    new-instance v1, Lorg/jboss/netty/channel/socket/http/n;

    invoke-direct {v1, v2}, Lorg/jboss/netty/channel/socket/http/n;-><init>(Ljavax/servlet/ServletOutputStream;)V
