...
.method constructor <init>(Lorg/jboss/netty/channel/ChannelFactory;Lorg/jboss/netty/channel/ChannelPipeline;Lorg/jboss/netty/channel/ChannelSink;Lorg/jboss/netty/channel/socket/nio/NioDatagramWorker;Lorg/jboss/netty/channel/socket/InternetProtocolFamily;)V
    ...
    invoke-direct/range {v0 .. v6}, Lorg/jboss/netty/channel/socket/nio/a;-><init>(Lorg/jboss/netty/channel/Channel;Lorg/jboss/netty/channel/ChannelFactory;Lorg/jboss/netty/channel/ChannelPipeline;Lorg/jboss/netty/channel/ChannelSink;Lorg/jboss/netty/channel/socket/nio/d;Ljava/nio/channels/SelectableChannel;)V

    new-instance v1, Lorg/jboss/netty/channel/socket/nio/e;
    ...
    invoke-direct {v1, v0}, Lorg/jboss/netty/channel/socket/nio/e;-><init>(Ljava/nio/channels/DatagramChannel;)V
...
.method private static openNonBlockingChannel(Lorg/jboss/netty/channel/socket/InternetProtocolFamily;)Ljava/nio/channels/DatagramChannel;
    ...
    :cond_1
    sget-object v0, Lorg/jboss/netty/channel/socket/nio/n;->a:[I
    ...
    :pswitch_0
    :try_start_1
    invoke-static {p0}, Lorg/jboss/netty/channel/socket/nio/y;->convert(Lorg/jboss/netty/channel/socket/InternetProtocolFamily;)Ljava/net/ProtocolFamily;
...
# virtual methods
.method public final block(Ljava/net/InetAddress;Ljava/net/InetAddress;)Lorg/jboss/netty/channel/ChannelFuture;
    .locals 1
...
.method public final block(Ljava/net/InetAddress;Ljava/net/NetworkInterface;Ljava/net/InetAddress;)Lorg/jboss/netty/channel/ChannelFuture;
    .locals 3
...
.method public final bridge synthetic getConfig()Lorg/jboss/netty/channel/ChannelConfig;
    .locals 1
...
.method public final bridge synthetic getConfig()Lorg/jboss/netty/channel/socket/DatagramChannelConfig;
    .locals 1
...
.method public final bridge synthetic getConfig()Lorg/jboss/netty/channel/socket/nio/NioChannelConfig;
    .locals 1
...
.method public final getConfig()Lorg/jboss/netty/channel/socket/nio/NioDatagramChannelConfig;
    .locals 1
...
.method final getDatagramChannel()Ljava/nio/channels/DatagramChannel;
    .locals 1
...
.method public final bridge synthetic getInterestOps()I
    .locals 1

    invoke-super {p0}, Lorg/jboss/netty/channel/socket/nio/a;->getInterestOps()I
...
.method public final bridge synthetic getLocalAddress()Ljava/net/InetSocketAddress;
    .locals 1

    invoke-super {p0}, Lorg/jboss/netty/channel/socket/nio/a;->getLocalAddress()Ljava/net/InetSocketAddress;
...
.method final getLocalSocketAddress()Ljava/net/InetSocketAddress;
    .locals 1
...
.method public final bridge synthetic getRemoteAddress()Ljava/net/InetSocketAddress;
    .locals 1

    invoke-super {p0}, Lorg/jboss/netty/channel/socket/nio/a;->getRemoteAddress()Ljava/net/InetSocketAddress;
...
.method final getRemoteSocketAddress()Ljava/net/InetSocketAddress;
    .locals 1
...
.method public final getWorker()Lorg/jboss/netty/channel/socket/nio/NioDatagramWorker;
    .locals 1

    invoke-super {p0}, Lorg/jboss/netty/channel/socket/nio/a;->getWorker()Lorg/jboss/netty/channel/socket/nio/d;
...
.method public final bridge synthetic getWorker()Lorg/jboss/netty/channel/socket/nio/d;
    .locals 1
...
.method public final joinGroup(Ljava/net/InetAddress;)Lorg/jboss/netty/channel/ChannelFuture;
    .locals 2
...
.method public final joinGroup(Ljava/net/InetAddress;Ljava/net/NetworkInterface;Ljava/net/InetAddress;)Lorg/jboss/netty/channel/ChannelFuture;
    .locals 3
...
.method public final joinGroup(Ljava/net/InetSocketAddress;Ljava/net/NetworkInterface;)Lorg/jboss/netty/channel/ChannelFuture;
    .locals 2
...
.method public final leaveGroup(Ljava/net/InetAddress;)Lorg/jboss/netty/channel/ChannelFuture;
    .locals 2
...
.method public final leaveGroup(Ljava/net/InetAddress;Ljava/net/NetworkInterface;Ljava/net/InetAddress;)Lorg/jboss/netty/channel/ChannelFuture;
    .locals 4
...
.method public final leaveGroup(Ljava/net/InetSocketAddress;Ljava/net/NetworkInterface;)Lorg/jboss/netty/channel/ChannelFuture;
    .locals 2
...
.method protected final setClosed()Z
    ...
    invoke-super {p0}, Lorg/jboss/netty/channel/socket/nio/a;->setClosed()Z
...
.method public final write(Ljava/lang/Object;Ljava/net/SocketAddress;)Lorg/jboss/netty/channel/ChannelFuture;
    .locals 1
    ...
    invoke-super {p0, p1, v0}, Lorg/jboss/netty/channel/socket/nio/a;->write(Ljava/lang/Object;Ljava/net/SocketAddress;)Lorg/jboss/netty/channel/ChannelFuture;
    ...
    :cond_1
    invoke-super {p0, p1, p2}, Lorg/jboss/netty/channel/socket/nio/a;->write(Ljava/lang/Object;Ljava/net/SocketAddress;)Lorg/jboss/netty/channel/ChannelFuture;
