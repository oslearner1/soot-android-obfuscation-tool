.class Lorg/jboss/netty/channel/socket/http/a;
...
# instance fields
.field final a:Lorg/jboss/netty/channel/socket/http/HttpTunnelingSocketChannelConfig;

.field volatile b:Z

.field final c:Lorg/jboss/netty/channel/socket/SocketChannel;

.field private final d:Lorg/jboss/netty/channel/socket/http/k;
...
.method constructor <init>(Lorg/jboss/netty/channel/ChannelFactory;Lorg/jboss/netty/channel/ChannelPipeline;Lorg/jboss/netty/channel/ChannelSink;Lorg/jboss/netty/channel/socket/ClientSocketChannelFactory;)V
    ...
    new-instance v0, Lorg/jboss/netty/channel/socket/http/k;

    invoke-direct {v0, p0}, Lorg/jboss/netty/channel/socket/http/k;-><init>(Lorg/jboss/netty/channel/socket/http/a;)V

    iput-object v0, p0, Lorg/jboss/netty/channel/socket/http/a;->d:Lorg/jboss/netty/channel/socket/http/k;

    new-instance v0, Lorg/jboss/netty/channel/socket/http/HttpTunnelingSocketChannelConfig;

    invoke-direct {v0, p0}, Lorg/jboss/netty/channel/socket/http/HttpTunnelingSocketChannelConfig;-><init>(Lorg/jboss/netty/channel/socket/http/a;)V

    iput-object v0, p0, Lorg/jboss/netty/channel/socket/http/a;->a:Lorg/jboss/netty/channel/socket/http/HttpTunnelingSocketChannelConfig;
    ...
    iget-object v2, p0, Lorg/jboss/netty/channel/socket/http/a;->d:Lorg/jboss/netty/channel/socket/http/k;
    ...
    iput-object v0, p0, Lorg/jboss/netty/channel/socket/http/a;->c:Lorg/jboss/netty/channel/socket/SocketChannel;
...
.method private a()Lorg/jboss/netty/channel/ChannelFuture;
    .locals 2

    iget-boolean v0, p0, Lorg/jboss/netty/channel/socket/http/a;->b:Z
    ...
    :cond_0
    iget-object v0, p0, Lorg/jboss/netty/channel/socket/http/a;->c:Lorg/jboss/netty/channel/socket/SocketChannel;
...
# virtual methods
.method final a(ILorg/jboss/netty/channel/ChannelFuture;)V
    .locals 2
    ...
    new-instance v1, Lorg/jboss/netty/channel/socket/http/f;

    invoke-direct {v1, p0, p2}, Lorg/jboss/netty/channel/socket/http/f;-><init>(Lorg/jboss/netty/channel/socket/http/a;Lorg/jboss/netty/channel/ChannelFuture;)V
...
.method final a(Ljava/net/SocketAddress;Lorg/jboss/netty/channel/ChannelFuture;)V
    .locals 2
    ...
    new-instance v1, Lorg/jboss/netty/channel/socket/http/b;

    invoke-direct {v1, p0, p2}, Lorg/jboss/netty/channel/socket/http/b;-><init>(Lorg/jboss/netty/channel/socket/http/a;Lorg/jboss/netty/channel/ChannelFuture;)V
...
.method final a(Lorg/jboss/netty/buffer/ChannelBuffer;Lorg/jboss/netty/channel/ChannelFuture;)V
    .locals 3
    ...
    :goto_0
    new-instance v2, Lorg/jboss/netty/channel/socket/http/e;

    invoke-direct {v2, p0, p2, v1}, Lorg/jboss/netty/channel/socket/http/e;-><init>(Lorg/jboss/netty/channel/socket/http/a;Lorg/jboss/netty/channel/ChannelFuture;I)V
...
.method final a(Lorg/jboss/netty/channel/ChannelFuture;)V
    ...
    invoke-direct {p0}, Lorg/jboss/netty/channel/socket/http/a;->a()Lorg/jboss/netty/channel/ChannelFuture;

    move-result-object v0

    new-instance v1, Lorg/jboss/netty/channel/socket/http/g;

    invoke-direct {v1, p0, p1}, Lorg/jboss/netty/channel/socket/http/g;-><init>(Lorg/jboss/netty/channel/socket/http/a;Lorg/jboss/netty/channel/ChannelFuture;)V
...
.method final b(Ljava/net/SocketAddress;Lorg/jboss/netty/channel/ChannelFuture;)V
    .locals 2
    ...
    new-instance v1, Lorg/jboss/netty/channel/socket/http/c;

    invoke-direct {v1, p0, p1, p2, p0}, Lorg/jboss/netty/channel/socket/http/c;-><init>(Lorg/jboss/netty/channel/socket/http/a;Ljava/net/SocketAddress;Lorg/jboss/netty/channel/ChannelFuture;Lorg/jboss/netty/channel/socket/SocketChannel;)V
...
.method final b(Lorg/jboss/netty/channel/ChannelFuture;)V
    .locals 2
    ...
    new-instance v1, Lorg/jboss/netty/channel/socket/http/i;

    invoke-direct {v1, p0, p1}, Lorg/jboss/netty/channel/socket/http/i;-><init>(Lorg/jboss/netty/channel/socket/http/a;Lorg/jboss/netty/channel/ChannelFuture;)V
...
.method public bridge synthetic getConfig()Lorg/jboss/netty/channel/ChannelConfig;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/channel/socket/http/a;->getConfig()Lorg/jboss/netty/channel/socket/http/HttpTunnelingSocketChannelConfig;
...
.method public getConfig()Lorg/jboss/netty/channel/socket/http/HttpTunnelingSocketChannelConfig;
    ...
    iget-object v0, p0, Lorg/jboss/netty/channel/socket/http/a;->a:Lorg/jboss/netty/channel/socket/http/HttpTunnelingSocketChannelConfig;
...
.method public bridge synthetic getLocalAddress()Ljava/net/SocketAddress;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/channel/socket/http/a;->getLocalAddress()Ljava/net/InetSocketAddress;
...
.method public bridge synthetic getRemoteAddress()Ljava/net/SocketAddress;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/channel/socket/http/a;->getRemoteAddress()Ljava/net/InetSocketAddress;
...
.method public write(Ljava/lang/Object;Ljava/net/SocketAddress;)Lorg/jboss/netty/channel/ChannelFuture;
    ...
    :cond_1
    invoke-virtual {p0}, Lorg/jboss/netty/channel/socket/http/a;->getUnsupportedOperationFuture()Lorg/jboss/netty/channel/ChannelFuture;
