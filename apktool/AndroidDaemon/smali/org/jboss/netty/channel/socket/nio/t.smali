.class Lorg/jboss/netty/channel/socket/nio/t;
...
# static fields
.field private static final d:Lorg/jboss/netty/logging/InternalLogger;


# instance fields
.field final a:Ljava/nio/channels/ServerSocketChannel;

.field final b:Ljava/util/concurrent/locks/Lock;

.field volatile c:Ljava/nio/channels/Selector;

.field private final e:Lorg/jboss/netty/channel/socket/ServerSocketChannelConfig;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lorg/jboss/netty/channel/socket/nio/t;

    invoke-static {v0}, Lorg/jboss/netty/logging/InternalLoggerFactory;->getInstance(Ljava/lang/Class;)Lorg/jboss/netty/logging/InternalLogger;

    move-result-object v0

    sput-object v0, Lorg/jboss/netty/channel/socket/nio/t;->d:Lorg/jboss/netty/logging/InternalLogger;
...
.method constructor <init>(Lorg/jboss/netty/channel/ChannelFactory;Lorg/jboss/netty/channel/ChannelPipeline;Lorg/jboss/netty/channel/ChannelSink;)V
    ...
    iput-object v0, p0, Lorg/jboss/netty/channel/socket/nio/t;->b:Ljava/util/concurrent/locks/Lock;
    ...
    iput-object v0, p0, Lorg/jboss/netty/channel/socket/nio/t;->a:Ljava/nio/channels/ServerSocketChannel;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    :try_start_1
    iget-object v0, p0, Lorg/jboss/netty/channel/socket/nio/t;->a:Ljava/nio/channels/ServerSocketChannel;
    ...
    iput-object v0, p0, Lorg/jboss/netty/channel/socket/nio/t;->e:Lorg/jboss/netty/channel/socket/ServerSocketChannelConfig;
    ...
    sget-object v2, Lorg/jboss/netty/channel/socket/nio/t;->d:Lorg/jboss/netty/logging/InternalLogger;
...
.method public bridge synthetic getConfig()Lorg/jboss/netty/channel/ChannelConfig;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/channel/socket/nio/t;->getConfig()Lorg/jboss/netty/channel/socket/ServerSocketChannelConfig;
...
.method public getConfig()Lorg/jboss/netty/channel/socket/ServerSocketChannelConfig;
    ...
    iget-object v0, p0, Lorg/jboss/netty/channel/socket/nio/t;->e:Lorg/jboss/netty/channel/socket/ServerSocketChannelConfig;
...
.method public bridge synthetic getLocalAddress()Ljava/net/SocketAddress;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/channel/socket/nio/t;->getLocalAddress()Ljava/net/InetSocketAddress;
...
.method public bridge synthetic getRemoteAddress()Ljava/net/SocketAddress;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/channel/socket/nio/t;->getRemoteAddress()Ljava/net/InetSocketAddress;
...
.method public isBound()Z
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/channel/socket/nio/t;->isOpen()Z
