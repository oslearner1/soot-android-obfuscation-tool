...
.method public execute(Lorg/jboss/netty/channel/ChannelPipeline;Ljava/lang/Runnable;)Lorg/jboss/netty/channel/ChannelFuture;
    ...
    instance-of v1, v0, Lorg/jboss/netty/channel/socket/nio/a;
    ...
    invoke-virtual {v0, v1}, Lorg/jboss/netty/channel/socket/nio/d;->executeInIoThread(Ljava/lang/Runnable;)V
...
.method protected isFireExceptionCaughtLater(Lorg/jboss/netty/channel/ChannelEvent;Ljava/lang/Throwable;)Z
    ...
    instance-of v2, v0, Lorg/jboss/netty/channel/socket/nio/a;

    if-eqz v2, :cond_1

    check-cast v0, Lorg/jboss/netty/channel/socket/nio/a;

    invoke-static {v0}, Lorg/jboss/netty/channel/socket/nio/d;->isIoThread(Lorg/jboss/netty/channel/socket/nio/a;)Z
