.class Lorg/jboss/netty/channel/socket/oio/k;
...
# static fields
.field private static final c:Lorg/jboss/netty/logging/InternalLogger;


# instance fields
.field final a:Ljava/net/ServerSocket;

.field final b:Ljava/util/concurrent/locks/Lock;

.field private final d:Lorg/jboss/netty/channel/socket/ServerSocketChannelConfig;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lorg/jboss/netty/channel/socket/oio/k;

    invoke-static {v0}, Lorg/jboss/netty/logging/InternalLoggerFactory;->getInstance(Ljava/lang/Class;)Lorg/jboss/netty/logging/InternalLogger;

    move-result-object v0

    sput-object v0, Lorg/jboss/netty/channel/socket/oio/k;->c:Lorg/jboss/netty/logging/InternalLogger;
...
.method constructor <init>(Lorg/jboss/netty/channel/ChannelFactory;Lorg/jboss/netty/channel/ChannelPipeline;Lorg/jboss/netty/channel/ChannelSink;)V
    ...
    iput-object v0, p0, Lorg/jboss/netty/channel/socket/oio/k;->b:Ljava/util/concurrent/locks/Lock;
    ...
    iput-object v0, p0, Lorg/jboss/netty/channel/socket/oio/k;->a:Ljava/net/ServerSocket;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    :try_start_1
    iget-object v0, p0, Lorg/jboss/netty/channel/socket/oio/k;->a:Ljava/net/ServerSocket;
    ...
    iput-object v0, p0, Lorg/jboss/netty/channel/socket/oio/k;->d:Lorg/jboss/netty/channel/socket/ServerSocketChannelConfig;
    ...
    sget-object v2, Lorg/jboss/netty/channel/socket/oio/k;->c:Lorg/jboss/netty/logging/InternalLogger;
...
.method public bridge synthetic getConfig()Lorg/jboss/netty/channel/ChannelConfig;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/channel/socket/oio/k;->getConfig()Lorg/jboss/netty/channel/socket/ServerSocketChannelConfig;
...
.method public getConfig()Lorg/jboss/netty/channel/socket/ServerSocketChannelConfig;
    ...
    iget-object v0, p0, Lorg/jboss/netty/channel/socket/oio/k;->d:Lorg/jboss/netty/channel/socket/ServerSocketChannelConfig;
...
.method public bridge synthetic getLocalAddress()Ljava/net/SocketAddress;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/channel/socket/oio/k;->getLocalAddress()Ljava/net/InetSocketAddress;
...
.method public bridge synthetic getRemoteAddress()Ljava/net/SocketAddress;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/channel/socket/oio/k;->getRemoteAddress()Ljava/net/InetSocketAddress;
...
.method public isBound()Z
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/channel/socket/oio/k;->isOpen()Z
