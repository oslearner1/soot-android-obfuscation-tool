...
.field private volatile settings:Lorg/jboss/netty/handler/execution/d;

.field private final totalLimiter$6d7ad1e7:Lorg/jboss/netty/handler/execution/a;
...
.method public constructor <init>(IJJJLjava/util/concurrent/TimeUnit;Lorg/jboss/netty/util/ObjectSizeEstimator;Ljava/util/concurrent/ThreadFactory;)V
    ...
    new-instance v9, Lorg/jboss/netty/handler/execution/c;

    const/4 v1, 0x0

    invoke-direct {v9, v1}, Lorg/jboss/netty/handler/execution/c;-><init>(B)V
    ...
    :goto_0
    new-instance v1, Lorg/jboss/netty/handler/execution/d;

    move-object/from16 v0, p9

    invoke-direct {v1, v0, p2, p3}, Lorg/jboss/netty/handler/execution/d;-><init>(Lorg/jboss/netty/util/ObjectSizeEstimator;J)V

    iput-object v1, p0, Lorg/jboss/netty/handler/execution/MemoryAwareThreadPoolExecutor;->settings:Lorg/jboss/netty/handler/execution/d;
    ...
    iput-object v1, p0, Lorg/jboss/netty/handler/execution/MemoryAwareThreadPoolExecutor;->totalLimiter$6d7ad1e7:Lorg/jboss/netty/handler/execution/a;
    ...
    :cond_3
    new-instance v1, Lorg/jboss/netty/handler/execution/a;

    invoke-direct {v1, p4, p5}, Lorg/jboss/netty/handler/execution/a;-><init>(J)V
...
.method protected decreaseCounter(Ljava/lang/Runnable;)V
    ...
    :cond_1
    iget-object v0, p0, Lorg/jboss/netty/handler/execution/MemoryAwareThreadPoolExecutor;->settings:Lorg/jboss/netty/handler/execution/d;

    iget-wide v1, v0, Lorg/jboss/netty/handler/execution/d;->b:J
    ...
    :goto_1
    iget-object v3, p0, Lorg/jboss/netty/handler/execution/MemoryAwareThreadPoolExecutor;->totalLimiter$6d7ad1e7:Lorg/jboss/netty/handler/execution/a;
    ...
    invoke-virtual {v3, v4, v5}, Lorg/jboss/netty/handler/execution/a;->b(J)V
    ...
    invoke-interface {v3, v8}, Lorg/jboss/netty/channel/Channel;->setReadable(Z)Lorg/jboss/netty/channel/ChannelFuture;
    ...
    check-cast v0, Lorg/jboss/netty/handler/execution/b;

    iget v0, v0, Lorg/jboss/netty/handler/execution/b;->a:I
...
.method public execute(Ljava/lang/Runnable;)V
    ...
    new-instance v0, Lorg/jboss/netty/handler/execution/b;

    invoke-direct {v0, p1}, Lorg/jboss/netty/handler/execution/b;-><init>(Ljava/lang/Runnable;)V
...
.method public getMaxChannelMemorySize()J
    ...
    iget-wide v0, v0, Lorg/jboss/netty/handler/execution/d;->b:J
...
.method public getMaxTotalMemorySize()J
    ...
    iget-object v0, p0, Lorg/jboss/netty/handler/execution/MemoryAwareThreadPoolExecutor;->totalLimiter$6d7ad1e7:Lorg/jboss/netty/handler/execution/a;

    iget-wide v0, v0, Lorg/jboss/netty/handler/execution/a;->a:J
...
.method public getObjectSizeEstimator()Lorg/jboss/netty/util/ObjectSizeEstimator;
    ...
    iget-object v0, v0, Lorg/jboss/netty/handler/execution/d;->a:Lorg/jboss/netty/util/ObjectSizeEstimator;
...
.method protected increaseCounter(Ljava/lang/Runnable;)V
    ...
    :cond_3
    :goto_1
    iget-object v1, p0, Lorg/jboss/netty/handler/execution/MemoryAwareThreadPoolExecutor;->totalLimiter$6d7ad1e7:Lorg/jboss/netty/handler/execution/a;
    ...
    invoke-virtual {v1, v2, v3}, Lorg/jboss/netty/handler/execution/a;->a(J)V

    goto :goto_0

    :cond_4
    check-cast p1, Lorg/jboss/netty/handler/execution/b;

    iput v0, p1, Lorg/jboss/netty/handler/execution/b;->a:I
...
.method public setMaxChannelMemorySize(J)V
    ...
    :cond_1
    new-instance v0, Lorg/jboss/netty/handler/execution/d;

    iget-object v1, p0, Lorg/jboss/netty/handler/execution/MemoryAwareThreadPoolExecutor;->settings:Lorg/jboss/netty/handler/execution/d;

    iget-object v1, v1, Lorg/jboss/netty/handler/execution/d;->a:Lorg/jboss/netty/util/ObjectSizeEstimator;

    invoke-direct {v0, v1, p1, p2}, Lorg/jboss/netty/handler/execution/d;-><init>(Lorg/jboss/netty/util/ObjectSizeEstimator;J)V

    iput-object v0, p0, Lorg/jboss/netty/handler/execution/MemoryAwareThreadPoolExecutor;->settings:Lorg/jboss/netty/handler/execution/d;
...
.method public setObjectSizeEstimator(Lorg/jboss/netty/util/ObjectSizeEstimator;)V
    ...
    iget-wide v1, v1, Lorg/jboss/netty/handler/execution/d;->b:J

    invoke-direct {v0, p1, v1, v2}, Lorg/jboss/netty/handler/execution/d;-><init>(Lorg/jboss/netty/util/ObjectSizeEstimator;J)V
