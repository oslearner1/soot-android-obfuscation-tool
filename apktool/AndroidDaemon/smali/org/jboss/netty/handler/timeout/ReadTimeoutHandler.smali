...
.method public constructor <init>(Lorg/jboss/netty/util/Timer;JLjava/util/concurrent/TimeUnit;)V
    ...
    iput-wide v1, p0, Lorg/jboss/netty/handler/timeout/ReadTimeoutHandler;->timeoutMillis:J
...
.method private static destroy(Lorg/jboss/netty/channel/ChannelHandlerContext;)V
    ...
    invoke-static {p0}, Lorg/jboss/netty/handler/timeout/ReadTimeoutHandler;->state(Lorg/jboss/netty/channel/ChannelHandlerContext;)Lorg/jboss/netty/handler/timeout/f;
    ...
    :try_start_0
    iget v0, v1, Lorg/jboss/netty/handler/timeout/f;->a:I
    ...
    iput v0, v1, Lorg/jboss/netty/handler/timeout/f;->a:I

    monitor-exit v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, v1, Lorg/jboss/netty/handler/timeout/f;->b:Lorg/jboss/netty/util/Timeout;
    ...
    iput-object v0, v1, Lorg/jboss/netty/handler/timeout/f;->b:Lorg/jboss/netty/util/Timeout;
...
.method private initialize(Lorg/jboss/netty/channel/ChannelHandlerContext;)V
    ...
    invoke-static {p1}, Lorg/jboss/netty/handler/timeout/ReadTimeoutHandler;->state(Lorg/jboss/netty/channel/ChannelHandlerContext;)Lorg/jboss/netty/handler/timeout/f;
    ...
    new-instance v2, Lorg/jboss/netty/handler/timeout/e;

    invoke-direct {v2, p0, p1}, Lorg/jboss/netty/handler/timeout/e;-><init>(Lorg/jboss/netty/handler/timeout/ReadTimeoutHandler;Lorg/jboss/netty/channel/ChannelHandlerContext;)V
...
.method private static state(Lorg/jboss/netty/channel/ChannelHandlerContext;)Lorg/jboss/netty/handler/timeout/f;
    .locals 1
    ...
    :cond_0
    new-instance v0, Lorg/jboss/netty/handler/timeout/f;

    invoke-direct {v0}, Lorg/jboss/netty/handler/timeout/f;-><init>()V
...
.method public messageReceived(Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/MessageEvent;)V
    ...
    iput-wide v1, v0, Lorg/jboss/netty/handler/timeout/f;->c:J
