...
.method private static destroy(Lorg/jboss/netty/channel/ChannelHandlerContext;)V
    ...
    invoke-static {p0}, Lorg/jboss/netty/handler/timeout/IdleStateHandler;->state(Lorg/jboss/netty/channel/ChannelHandlerContext;)Lorg/jboss/netty/handler/timeout/c;
    ...
    :try_start_0
    iget v0, v1, Lorg/jboss/netty/handler/timeout/c;->a:I
    ...
    iput v0, v1, Lorg/jboss/netty/handler/timeout/c;->a:I

    monitor-exit v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, v1, Lorg/jboss/netty/handler/timeout/c;->b:Lorg/jboss/netty/util/Timeout;
    ...
    iput-object v3, v1, Lorg/jboss/netty/handler/timeout/c;->b:Lorg/jboss/netty/util/Timeout;

    :cond_2
    iget-object v0, v1, Lorg/jboss/netty/handler/timeout/c;->d:Lorg/jboss/netty/util/Timeout;
    ...
    iput-object v3, v1, Lorg/jboss/netty/handler/timeout/c;->d:Lorg/jboss/netty/util/Timeout;

    :cond_3
    iget-object v0, v1, Lorg/jboss/netty/handler/timeout/c;->f:Lorg/jboss/netty/util/Timeout;
    ...
    iput-object v3, v1, Lorg/jboss/netty/handler/timeout/c;->f:Lorg/jboss/netty/util/Timeout;
...
.method private initialize(Lorg/jboss/netty/channel/ChannelHandlerContext;)V
    ...
    invoke-static {p1}, Lorg/jboss/netty/handler/timeout/IdleStateHandler;->state(Lorg/jboss/netty/channel/ChannelHandlerContext;)Lorg/jboss/netty/handler/timeout/c;
    ...
    iput-wide v2, v1, Lorg/jboss/netty/handler/timeout/c;->e:J

    iput-wide v2, v1, Lorg/jboss/netty/handler/timeout/c;->c:J
    ...
    new-instance v2, Lorg/jboss/netty/handler/timeout/b;

    invoke-direct {v2, p0, p1}, Lorg/jboss/netty/handler/timeout/b;-><init>(Lorg/jboss/netty/handler/timeout/IdleStateHandler;Lorg/jboss/netty/channel/ChannelHandlerContext;)V

    iget-wide v3, p0, Lorg/jboss/netty/handler/timeout/IdleStateHandler;->readerIdleTimeMillis:J

    sget-object v5, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-interface {v0, v2, v3, v4, v5}, Lorg/jboss/netty/util/Timer;->newTimeout(Lorg/jboss/netty/util/TimerTask;JLjava/util/concurrent/TimeUnit;)Lorg/jboss/netty/util/Timeout;

    move-result-object v0

    iput-object v0, v1, Lorg/jboss/netty/handler/timeout/c;->b:Lorg/jboss/netty/util/Timeout;
    ...
    new-instance v2, Lorg/jboss/netty/handler/timeout/d;

    invoke-direct {v2, p0, p1}, Lorg/jboss/netty/handler/timeout/d;-><init>(Lorg/jboss/netty/handler/timeout/IdleStateHandler;Lorg/jboss/netty/channel/ChannelHandlerContext;)V
    ...
    iput-object v0, v1, Lorg/jboss/netty/handler/timeout/c;->d:Lorg/jboss/netty/util/Timeout;
    ...
    new-instance v2, Lorg/jboss/netty/handler/timeout/a;

    invoke-direct {v2, p0, p1}, Lorg/jboss/netty/handler/timeout/a;-><init>(Lorg/jboss/netty/handler/timeout/IdleStateHandler;Lorg/jboss/netty/channel/ChannelHandlerContext;)V
    ...
    iput-object v0, v1, Lorg/jboss/netty/handler/timeout/c;->f:Lorg/jboss/netty/util/Timeout;
...
.method private static state(Lorg/jboss/netty/channel/ChannelHandlerContext;)Lorg/jboss/netty/handler/timeout/c;
    .locals 1
    ...
    :cond_0
    new-instance v0, Lorg/jboss/netty/handler/timeout/c;

    invoke-direct {v0}, Lorg/jboss/netty/handler/timeout/c;-><init>()V
...
.method public messageReceived(Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/MessageEvent;)V
    ...
    iput-wide v1, v0, Lorg/jboss/netty/handler/timeout/c;->c:J
...
.method public writeComplete(Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/WriteCompletionEvent;)V
    ...
    iput-wide v1, v0, Lorg/jboss/netty/handler/timeout/c;->e:J
