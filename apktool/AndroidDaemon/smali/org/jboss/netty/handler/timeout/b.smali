.class final Lorg/jboss/netty/handler/timeout/b;
...
.method constructor <init>(Lorg/jboss/netty/handler/timeout/IdleStateHandler;Lorg/jboss/netty/channel/ChannelHandlerContext;)V
    ...
    iput-object p1, p0, Lorg/jboss/netty/handler/timeout/b;->b:Lorg/jboss/netty/handler/timeout/IdleStateHandler;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lorg/jboss/netty/handler/timeout/b;->a:Lorg/jboss/netty/channel/ChannelHandlerContext;
...
.method public final run(Lorg/jboss/netty/util/Timeout;)V
    ...
    iget-object v0, p0, Lorg/jboss/netty/handler/timeout/b;->a:Lorg/jboss/netty/channel/ChannelHandlerContext;
    ...
    iget-wide v3, v0, Lorg/jboss/netty/handler/timeout/c;->c:J

    iget-object v5, p0, Lorg/jboss/netty/handler/timeout/b;->b:Lorg/jboss/netty/handler/timeout/IdleStateHandler;
    ...
    iget-object v1, p0, Lorg/jboss/netty/handler/timeout/b;->b:Lorg/jboss/netty/handler/timeout/IdleStateHandler;

    iget-object v1, v1, Lorg/jboss/netty/handler/timeout/IdleStateHandler;->timer:Lorg/jboss/netty/util/Timer;

    iget-object v2, p0, Lorg/jboss/netty/handler/timeout/b;->b:Lorg/jboss/netty/handler/timeout/IdleStateHandler;

    iget-wide v5, v2, Lorg/jboss/netty/handler/timeout/IdleStateHandler;->readerIdleTimeMillis:J
    ...
    iput-object v1, v0, Lorg/jboss/netty/handler/timeout/c;->b:Lorg/jboss/netty/util/Timeout;

    :try_start_0
    iget-object v0, p0, Lorg/jboss/netty/handler/timeout/b;->b:Lorg/jboss/netty/handler/timeout/IdleStateHandler;

    iget-object v1, p0, Lorg/jboss/netty/handler/timeout/b;->a:Lorg/jboss/netty/channel/ChannelHandlerContext;

    sget-object v2, Lorg/jboss/netty/handler/timeout/IdleState;->READER_IDLE:Lorg/jboss/netty/handler/timeout/IdleState;
    ...
    :cond_2
    iget-object v3, p0, Lorg/jboss/netty/handler/timeout/b;->b:Lorg/jboss/netty/handler/timeout/IdleStateHandler;
