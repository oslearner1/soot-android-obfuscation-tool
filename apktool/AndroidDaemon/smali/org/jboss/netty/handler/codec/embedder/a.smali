.class abstract Lorg/jboss/netty/handler/codec/embedder/a;
...
.field private final sink:Lorg/jboss/netty/handler/codec/embedder/c;
...
.method protected varargs constructor <init>(Lorg/jboss/netty/buffer/ChannelBufferFactory;[Lorg/jboss/netty/channel/ChannelHandler;)V
    ...
    invoke-direct {p0, p2}, Lorg/jboss/netty/handler/codec/embedder/a;-><init>([Lorg/jboss/netty/channel/ChannelHandler;)V

    invoke-virtual {p0}, Lorg/jboss/netty/handler/codec/embedder/a;->getChannel()Lorg/jboss/netty/channel/Channel;
...
.method protected varargs constructor <init>([Lorg/jboss/netty/channel/ChannelHandler;)V
    ...
    new-instance v0, Lorg/jboss/netty/handler/codec/embedder/c;

    invoke-direct {v0, p0}, Lorg/jboss/netty/handler/codec/embedder/c;-><init>(Lorg/jboss/netty/handler/codec/embedder/a;)V

    iput-object v0, p0, Lorg/jboss/netty/handler/codec/embedder/a;->sink:Lorg/jboss/netty/handler/codec/embedder/c;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lorg/jboss/netty/handler/codec/embedder/a;->productQueue:Ljava/util/Queue;

    new-instance v0, Lorg/jboss/netty/handler/codec/embedder/b;

    invoke-direct {v0}, Lorg/jboss/netty/handler/codec/embedder/b;-><init>()V

    iput-object v0, p0, Lorg/jboss/netty/handler/codec/embedder/a;->pipeline:Lorg/jboss/netty/channel/ChannelPipeline;

    invoke-direct {p0, p1}, Lorg/jboss/netty/handler/codec/embedder/a;->configurePipeline([Lorg/jboss/netty/channel/ChannelHandler;)V

    new-instance v0, Lorg/jboss/netty/handler/codec/embedder/d;

    iget-object v1, p0, Lorg/jboss/netty/handler/codec/embedder/a;->pipeline:Lorg/jboss/netty/channel/ChannelPipeline;

    iget-object v2, p0, Lorg/jboss/netty/handler/codec/embedder/a;->sink:Lorg/jboss/netty/handler/codec/embedder/c;

    invoke-direct {v0, v1, v2}, Lorg/jboss/netty/handler/codec/embedder/d;-><init>(Lorg/jboss/netty/channel/ChannelPipeline;Lorg/jboss/netty/channel/ChannelSink;)V

    iput-object v0, p0, Lorg/jboss/netty/handler/codec/embedder/a;->channel:Lorg/jboss/netty/channel/Channel;

    invoke-direct {p0}, Lorg/jboss/netty/handler/codec/embedder/a;->fireInitialEvents()V
...
.method private varargs configurePipeline([Lorg/jboss/netty/channel/ChannelHandler;)V
    ...
    :cond_3
    iget-object v0, p0, Lorg/jboss/netty/handler/codec/embedder/a;->pipeline:Lorg/jboss/netty/channel/ChannelPipeline;
...
.method private fireInitialEvents()V
    ...
    iget-object v0, p0, Lorg/jboss/netty/handler/codec/embedder/a;->channel:Lorg/jboss/netty/channel/Channel;

    invoke-static {v0}, Lorg/jboss/netty/channel/Channels;->fireChannelOpen(Lorg/jboss/netty/channel/Channel;)V

    iget-object v0, p0, Lorg/jboss/netty/handler/codec/embedder/a;->channel:Lorg/jboss/netty/channel/Channel;

    iget-object v1, p0, Lorg/jboss/netty/handler/codec/embedder/a;->channel:Lorg/jboss/netty/channel/Channel;
...
.method public finish()Z
    ...
    iget-object v0, p0, Lorg/jboss/netty/handler/codec/embedder/a;->productQueue:Ljava/util/Queue;
...
.method public final pollAll()[Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/handler/codec/embedder/a;->size()I
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/handler/codec/embedder/a;->poll()Ljava/lang/Object;
