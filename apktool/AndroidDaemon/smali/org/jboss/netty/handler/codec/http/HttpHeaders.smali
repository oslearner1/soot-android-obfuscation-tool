...
# instance fields
.field private final entries:[Lorg/jboss/netty/handler/codec/http/h;

.field private final head:Lorg/jboss/netty/handler/codec/http/h;
...
.method constructor <init>()V
    ...
    new-array v0, v0, [Lorg/jboss/netty/handler/codec/http/h;

    iput-object v0, p0, Lorg/jboss/netty/handler/codec/http/HttpHeaders;->entries:[Lorg/jboss/netty/handler/codec/http/h;

    new-instance v0, Lorg/jboss/netty/handler/codec/http/h;

    const/4 v1, -0x1

    invoke-direct {v0, v1, v2, v2}, Lorg/jboss/netty/handler/codec/http/h;-><init>(ILjava/lang/String;Ljava/lang/String;)V

    iput-object v0, p0, Lorg/jboss/netty/handler/codec/http/HttpHeaders;->head:Lorg/jboss/netty/handler/codec/http/h;

    iget-object v0, p0, Lorg/jboss/netty/handler/codec/http/HttpHeaders;->head:Lorg/jboss/netty/handler/codec/http/h;

    iget-object v1, p0, Lorg/jboss/netty/handler/codec/http/HttpHeaders;->head:Lorg/jboss/netty/handler/codec/http/h;

    iget-object v2, p0, Lorg/jboss/netty/handler/codec/http/HttpHeaders;->head:Lorg/jboss/netty/handler/codec/http/h;

    iput-object v2, v1, Lorg/jboss/netty/handler/codec/http/h;->f:Lorg/jboss/netty/handler/codec/http/h;

    iput-object v2, v0, Lorg/jboss/netty/handler/codec/http/h;->e:Lorg/jboss/netty/handler/codec/http/h;
...
.method private addHeader0(IILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lorg/jboss/netty/handler/codec/http/HttpHeaders;->entries:[Lorg/jboss/netty/handler/codec/http/h;

    aget-object v0, v0, p2

    iget-object v1, p0, Lorg/jboss/netty/handler/codec/http/HttpHeaders;->entries:[Lorg/jboss/netty/handler/codec/http/h;

    new-instance v2, Lorg/jboss/netty/handler/codec/http/h;

    invoke-direct {v2, p1, p3, p4}, Lorg/jboss/netty/handler/codec/http/h;-><init>(ILjava/lang/String;Ljava/lang/String;)V

    aput-object v2, v1, p2

    iput-object v0, v2, Lorg/jboss/netty/handler/codec/http/h;->d:Lorg/jboss/netty/handler/codec/http/h;

    iget-object v0, p0, Lorg/jboss/netty/handler/codec/http/HttpHeaders;->head:Lorg/jboss/netty/handler/codec/http/h;

    invoke-virtual {v2, v0}, Lorg/jboss/netty/handler/codec/http/h;->a(Lorg/jboss/netty/handler/codec/http/h;)V
...
.method private removeHeader0(IILjava/lang/String;)V
    ...
    :cond_1
    :goto_1
    iget v1, v0, Lorg/jboss/netty/handler/codec/http/h;->a:I

    if-ne v1, p1, :cond_3

    iget-object v1, v0, Lorg/jboss/netty/handler/codec/http/h;->b:Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lorg/jboss/netty/handler/codec/http/h;->a()V

    iget-object v0, v0, Lorg/jboss/netty/handler/codec/http/h;->d:Lorg/jboss/netty/handler/codec/http/h;
    ...
    :cond_3
    :goto_2
    iget-object v1, v0, Lorg/jboss/netty/handler/codec/http/h;->d:Lorg/jboss/netty/handler/codec/http/h;

    if-eqz v1, :cond_0

    iget v2, v1, Lorg/jboss/netty/handler/codec/http/h;->a:I

    if-ne v2, p1, :cond_4

    iget-object v2, v1, Lorg/jboss/netty/handler/codec/http/h;->b:Ljava/lang/String;
    ...
    iget-object v2, v1, Lorg/jboss/netty/handler/codec/http/h;->d:Lorg/jboss/netty/handler/codec/http/h;

    iput-object v2, v0, Lorg/jboss/netty/handler/codec/http/h;->d:Lorg/jboss/netty/handler/codec/http/h;

    invoke-virtual {v1}, Lorg/jboss/netty/handler/codec/http/h;->a()V
...
.method addHeader(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Lorg/jboss/netty/handler/codec/http/f;->a(Ljava/lang/String;)V
...
.method getHeader(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, p0, Lorg/jboss/netty/handler/codec/http/HttpHeaders;->entries:[Lorg/jboss/netty/handler/codec/http/h;
    ...
    iget v2, v0, Lorg/jboss/netty/handler/codec/http/h;->a:I

    if-ne v2, v1, :cond_1

    iget-object v2, v0, Lorg/jboss/netty/handler/codec/http/h;->b:Ljava/lang/String;
    ...
    iget-object v0, v0, Lorg/jboss/netty/handler/codec/http/h;->c:Ljava/lang/String;
...
.method getHeaderNames()Ljava/util/Set;
    ...
    iget-object v0, v0, Lorg/jboss/netty/handler/codec/http/h;->f:Lorg/jboss/netty/handler/codec/http/h;
...
.method getHeaders(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, p0, Lorg/jboss/netty/handler/codec/http/HttpHeaders;->entries:[Lorg/jboss/netty/handler/codec/http/h;
    ...
    iget v3, v0, Lorg/jboss/netty/handler/codec/http/h;->a:I

    if-ne v3, v2, :cond_1

    iget-object v3, v0, Lorg/jboss/netty/handler/codec/http/h;->b:Ljava/lang/String;
    ...
    iget-object v3, v0, Lorg/jboss/netty/handler/codec/http/h;->c:Ljava/lang/String;
...
.method setHeader(Ljava/lang/String;Ljava/lang/Iterable;)V
    ...
    invoke-static {v3}, Lorg/jboss/netty/handler/codec/http/f;->a(Ljava/lang/String;)V
