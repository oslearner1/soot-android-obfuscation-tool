...
.field private final spdySession:Lorg/jboss/netty/handler/codec/spdy/p;
...
.method public constructor <init>(IZ)V
    ...
    new-instance v0, Lorg/jboss/netty/handler/codec/spdy/p;

    invoke-direct {v0}, Lorg/jboss/netty/handler/codec/spdy/p;-><init>()V

    iput-object v0, p0, Lorg/jboss/netty/handler/codec/spdy/SpdySessionHandler;->spdySession:Lorg/jboss/netty/handler/codec/spdy/p;
...
.method private declared-synchronized acceptStream(IBZZ)Z
    ...
    iget-object v2, p0, Lorg/jboss/netty/handler/codec/spdy/SpdySessionHandler;->spdySession:Lorg/jboss/netty/handler/codec/spdy/p;

    invoke-virtual {v2}, Lorg/jboss/netty/handler/codec/spdy/p;->a()I
    ...
    :cond_2
    iget-object v0, p0, Lorg/jboss/netty/handler/codec/spdy/SpdySessionHandler;->spdySession:Lorg/jboss/netty/handler/codec/spdy/p;
    ...
    invoke-virtual/range {v0 .. v6}, Lorg/jboss/netty/handler/codec/spdy/p;->a(IBZZII)V
...
.method private halfCloseStream(IZ)V
    ...
    invoke-virtual {v0, p1}, Lorg/jboss/netty/handler/codec/spdy/p;->d(I)V
    ...
    invoke-virtual {v0}, Lorg/jboss/netty/handler/codec/spdy/p;->b()Z
    ...
    invoke-virtual {v0, p1}, Lorg/jboss/netty/handler/codec/spdy/p;->f(I)V
...
.method private isRemoteInitiatedID(I)Z
    ...
    invoke-static {p1}, Lorg/jboss/netty/handler/codec/spdy/b;->a(I)Z
...
.method private issueStreamError(Lorg/jboss/netty/channel/ChannelHandlerContext;Ljava/net/SocketAddress;ILorg/jboss/netty/handler/codec/spdy/SpdyStreamStatus;)V
    ...
    invoke-virtual {v0, p3}, Lorg/jboss/netty/handler/codec/spdy/p;->c(I)Z
...
.method private removeStream(I)V
    ...
    invoke-virtual {v0, p1}, Lorg/jboss/netty/handler/codec/spdy/p;->b(I)V
...
.method private sendGoAwayFrame(Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/ChannelStateEvent;)V
    ...
    iget-object v1, p0, Lorg/jboss/netty/handler/codec/spdy/SpdySessionHandler;->spdySession:Lorg/jboss/netty/handler/codec/spdy/p;

    invoke-virtual {v1}, Lorg/jboss/netty/handler/codec/spdy/p;->b()Z

    move-result v1

    if-eqz v1, :cond_1

    new-instance v1, Lorg/jboss/netty/handler/codec/spdy/x;

    invoke-direct {v1, p1, p2}, Lorg/jboss/netty/handler/codec/spdy/x;-><init>(Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/ChannelStateEvent;)V
...
.method private declared-synchronized updateInitialReceiveWindowSize(I)V
    ...
    invoke-virtual {v1, v0}, Lorg/jboss/netty/handler/codec/spdy/p;->k(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private declared-synchronized updateInitialSendWindowSize(I)V
    ...
    invoke-virtual {v0}, Lorg/jboss/netty/handler/codec/spdy/p;->c()Ljava/util/Set;
    ...
    iget-object v3, p0, Lorg/jboss/netty/handler/codec/spdy/SpdySessionHandler;->spdySession:Lorg/jboss/netty/handler/codec/spdy/p;

    invoke-virtual {v0}, Ljava/lang/Integer;->intValue()I

    move-result v0

    invoke-virtual {v3, v0, v1}, Lorg/jboss/netty/handler/codec/spdy/p;->a(II)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private updateSendWindowSize(Lorg/jboss/netty/channel/ChannelHandlerContext;II)V
    ...
    invoke-virtual {v0, p2, p3}, Lorg/jboss/netty/handler/codec/spdy/p;->a(II)I
    ...
    invoke-virtual {v0, p2}, Lorg/jboss/netty/handler/codec/spdy/p;->l(I)Lorg/jboss/netty/channel/MessageEvent;
    ...
    invoke-virtual {v1, p2}, Lorg/jboss/netty/handler/codec/spdy/p;->m(I)Lorg/jboss/netty/channel/MessageEvent;

    iget-object v1, p0, Lorg/jboss/netty/handler/codec/spdy/SpdySessionHandler;->spdySession:Lorg/jboss/netty/handler/codec/spdy/p;

    mul-int/lit8 v5, v5, -0x1

    invoke-virtual {v1, p2, v5}, Lorg/jboss/netty/handler/codec/spdy/p;->a(II)I
    ...
    new-instance v7, Lorg/jboss/netty/handler/codec/spdy/u;

    invoke-direct {v7, p0, p1, v5, p2}, Lorg/jboss/netty/handler/codec/spdy/u;-><init>(Lorg/jboss/netty/handler/codec/spdy/SpdySessionHandler;Lorg/jboss/netty/channel/ChannelHandlerContext;Ljava/net/SocketAddress;I)V
    ...
    :cond_1
    :try_start_1
    iget-object v5, p0, Lorg/jboss/netty/handler/codec/spdy/SpdySessionHandler;->spdySession:Lorg/jboss/netty/handler/codec/spdy/p;

    mul-int/lit8 v6, v1, -0x1

    invoke-virtual {v5, p2, v6}, Lorg/jboss/netty/handler/codec/spdy/p;->a(II)I
    ...
    new-instance v6, Lorg/jboss/netty/handler/codec/spdy/v;

    invoke-direct {v6, p0, p1, v1, p2}, Lorg/jboss/netty/handler/codec/spdy/v;-><init>(Lorg/jboss/netty/handler/codec/spdy/SpdySessionHandler;Lorg/jboss/netty/channel/ChannelHandlerContext;Ljava/net/SocketAddress;I)V
...
.method public handleDownstream(Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/ChannelEvent;)V
    ...
    sget-object v1, Lorg/jboss/netty/handler/codec/spdy/w;->a:[I
    ...
    invoke-virtual {v3, v2}, Lorg/jboss/netty/handler/codec/spdy/p;->e(I)Z
    ...
    invoke-virtual {v5, v2}, Lorg/jboss/netty/handler/codec/spdy/p;->i(I)I
    ...
    invoke-virtual {v5, v2, v4}, Lorg/jboss/netty/handler/codec/spdy/p;->a(II)I
    ...
    new-instance v5, Lorg/jboss/netty/handler/codec/spdy/s;

    invoke-direct {v5, p0, p1, v4, v2}, Lorg/jboss/netty/handler/codec/spdy/s;-><init>(Lorg/jboss/netty/handler/codec/spdy/SpdySessionHandler;Lorg/jboss/netty/channel/ChannelHandlerContext;Ljava/net/SocketAddress;I)V
    ...
    :try_start_1
    iget-object v4, p0, Lorg/jboss/netty/handler/codec/spdy/SpdySessionHandler;->spdySession:Lorg/jboss/netty/handler/codec/spdy/p;

    mul-int/lit8 v6, v5, -0x1

    invoke-virtual {v4, v2, v6}, Lorg/jboss/netty/handler/codec/spdy/p;->a(II)I
    ...
    invoke-virtual {v1, v2, v0}, Lorg/jboss/netty/handler/codec/spdy/p;->a(ILorg/jboss/netty/channel/MessageEvent;)Z
    ...
    new-instance v6, Lorg/jboss/netty/handler/codec/spdy/t;

    invoke-direct {v6, p0, p1, v5, v2}, Lorg/jboss/netty/handler/codec/spdy/t;-><init>(Lorg/jboss/netty/handler/codec/spdy/SpdySessionHandler;Lorg/jboss/netty/channel/ChannelHandlerContext;Ljava/net/SocketAddress;I)V
...
.method public messageReceived(Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/MessageEvent;)V
    ...
    invoke-virtual {v2, v1}, Lorg/jboss/netty/handler/codec/spdy/p;->a(I)Z
    ...
    invoke-virtual {v2, v1}, Lorg/jboss/netty/handler/codec/spdy/p;->c(I)Z
    ...
    invoke-virtual {v2, v1}, Lorg/jboss/netty/handler/codec/spdy/p;->g(I)Z
    ...
    invoke-virtual {v3, v1, v2}, Lorg/jboss/netty/handler/codec/spdy/p;->b(II)I

    move-result v2

    iget-object v3, p0, Lorg/jboss/netty/handler/codec/spdy/SpdySessionHandler;->spdySession:Lorg/jboss/netty/handler/codec/spdy/p;

    invoke-virtual {v3, v1}, Lorg/jboss/netty/handler/codec/spdy/p;->j(I)I
    ...
    invoke-virtual {v2, v1}, Lorg/jboss/netty/handler/codec/spdy/p;->h(I)V
    ...
    invoke-virtual {v2, v1}, Lorg/jboss/netty/handler/codec/spdy/p;->e(I)Z
    ...
    invoke-virtual {v2, v1}, Lorg/jboss/netty/handler/codec/spdy/p;->i(I)I
