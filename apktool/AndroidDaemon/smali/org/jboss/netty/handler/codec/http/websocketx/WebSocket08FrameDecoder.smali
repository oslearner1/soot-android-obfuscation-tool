...
.field private fragmentedFramesText:Lorg/jboss/netty/handler/codec/http/websocketx/b;
...
.method private checkUTF8String(Lorg/jboss/netty/channel/Channel;[B)V
    ...
    :try_start_0
    iget-object v0, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameDecoder;->fragmentedFramesText:Lorg/jboss/netty/handler/codec/http/websocketx/b;

    if-nez v0, :cond_0

    new-instance v0, Lorg/jboss/netty/handler/codec/http/websocketx/b;

    invoke-direct {v0, p2}, Lorg/jboss/netty/handler/codec/http/websocketx/b;-><init>([B)V

    iput-object v0, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameDecoder;->fragmentedFramesText:Lorg/jboss/netty/handler/codec/http/websocketx/b;
    ...
    invoke-virtual {v0, p2}, Lorg/jboss/netty/handler/codec/http/websocketx/b;->write([B)V
    :try_end_0
    .catch Lorg/jboss/netty/handler/codec/http/websocketx/a; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected checkCloseFrameBody(Lorg/jboss/netty/channel/Channel;Lorg/jboss/netty/buffer/ChannelBuffer;)V
    ...
    :try_start_0
    new-instance v2, Lorg/jboss/netty/handler/codec/http/websocketx/b;

    invoke-direct {v2, v1}, Lorg/jboss/netty/handler/codec/http/websocketx/b;-><init>([B)V
    :try_end_0
    .catch Lorg/jboss/netty/handler/codec/http/websocketx/a; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected decode(Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/Channel;Lorg/jboss/netty/buffer/ChannelBuffer;Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameDecoder$State;)Ljava/lang/Object;
    ...
    :cond_0
    sget-object v0, Lorg/jboss/netty/handler/codec/http/websocketx/c;->a:[I
    ...
    iget-wide v1, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameDecoder;->maxFramePayloadLength:J
    ...
    iget-wide v5, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameDecoder;->framePayloadLength:J
    ...
    invoke-virtual {v0}, Lorg/jboss/netty/handler/codec/http/websocketx/b;->toString()Ljava/lang/String;

    move-result-object v0

    iput-object v3, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameDecoder;->fragmentedFramesText:Lorg/jboss/netty/handler/codec/http/websocketx/b;
