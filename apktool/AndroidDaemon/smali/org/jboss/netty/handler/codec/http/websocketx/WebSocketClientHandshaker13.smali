...
.method public finishHandshake(Lorg/jboss/netty/channel/Channel;Lorg/jboss/netty/handler/codec/http/HttpResponse;)V
    ...
    iget-object v1, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker13;->expectedChallengeResponseString:Ljava/lang/String;
    ...
    iget-object v4, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker13;->expectedChallengeResponseString:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker13;->setActualSubprotocol(Ljava/lang/String;)V
    ...
    new-instance v2, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket13FrameDecoder;

    iget-boolean v3, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker13;->allowExtensions:Z

    invoke-virtual {p0}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker13;->getMaxFramePayloadLength()J

    move-result-wide v4

    invoke-direct {v2, v6, v3, v4, v5}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket13FrameDecoder;-><init>(ZZJ)V
...
.method public handshake(Lorg/jboss/netty/channel/Channel;)Lorg/jboss/netty/channel/ChannelFuture;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker13;->getWebSocketUrl()Ljava/net/URI;
    ...
    iput-object v3, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker13;->expectedChallengeResponseString:Ljava/lang/String;

    sget-object v3, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker13;->logger:Lorg/jboss/netty/logging/InternalLogger;
    ...
    const-string v4, "WS Version 13 Client Handshake key: %s. Expected response: %s."
    ...
    iget-object v6, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker13;->expectedChallengeResponseString:Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker13;->getExpectedSubprotocol()Ljava/lang/String;
    ...
    iget-object v0, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker13;->customHeaders:Ljava/util/Map;
    ...
    iget-object v2, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker13;->customHeaders:Ljava/util/Map;
    ...
    invoke-direct {v4, v7}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket13FrameEncoder;-><init>(Z)V
