...
.field private final headerBlockCompressor:Lorg/jboss/netty/handler/codec/spdy/i;
...
.method public constructor <init>(IIII)V
    ...
    new-instance v0, Lorg/jboss/netty/handler/codec/spdy/l;

    invoke-direct {v0, p1, p2}, Lorg/jboss/netty/handler/codec/spdy/l;-><init>(II)V

    :goto_0
    iput-object v0, p0, Lorg/jboss/netty/handler/codec/spdy/SpdyFrameEncoder;->headerBlockCompressor:Lorg/jboss/netty/handler/codec/spdy/i;

    return-void

    :cond_2
    new-instance v0, Lorg/jboss/netty/handler/codec/spdy/k;

    invoke-direct {v0, p1, p2, p3, p4}, Lorg/jboss/netty/handler/codec/spdy/k;-><init>(IIII)V
...
.method private compressHeaderBlock(Lorg/jboss/netty/buffer/ChannelBuffer;)Lorg/jboss/netty/buffer/ChannelBuffer;
    ...
    iget-object v1, p0, Lorg/jboss/netty/handler/codec/spdy/SpdyFrameEncoder;->headerBlockCompressor:Lorg/jboss/netty/handler/codec/spdy/i;

    invoke-virtual {v1, p1}, Lorg/jboss/netty/handler/codec/spdy/i;->setInput(Lorg/jboss/netty/buffer/ChannelBuffer;)V

    iget-object v1, p0, Lorg/jboss/netty/handler/codec/spdy/SpdyFrameEncoder;->headerBlockCompressor:Lorg/jboss/netty/handler/codec/spdy/i;

    invoke-virtual {v1, v0}, Lorg/jboss/netty/handler/codec/spdy/i;->encode(Lorg/jboss/netty/buffer/ChannelBuffer;)V
...
.method private static encodeHeaderBlock(ILorg/jboss/netty/handler/codec/spdy/SpdyHeaderBlock;)Lorg/jboss/netty/buffer/ChannelBuffer;
    ...
    invoke-interface {v4, v0}, Lorg/jboss/netty/buffer/ChannelBuffer;->writeBytes([B)V
    ...
    invoke-interface {p1, v1}, Lorg/jboss/netty/handler/codec/spdy/SpdyHeaderBlock;->getHeaders(Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_3
    invoke-static {p0, v4, v6, v0}, Lorg/jboss/netty/handler/codec/spdy/SpdyFrameEncoder;->setLengthField(ILorg/jboss/netty/buffer/ChannelBuffer;II)V
...
.method public handleDownstream(Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/ChannelEvent;)V
    ...
    sget-object v1, Lorg/jboss/netty/handler/codec/spdy/h;->a:[I
    ...
    iget-object v0, p0, Lorg/jboss/netty/handler/codec/spdy/SpdyFrameEncoder;->headerBlockCompressor:Lorg/jboss/netty/handler/codec/spdy/i;

    invoke-virtual {v0}, Lorg/jboss/netty/handler/codec/spdy/i;->end()V
    ...
    iget-object v5, p0, Lorg/jboss/netty/handler/codec/spdy/SpdyFrameEncoder;->headerBlockCompressor:Lorg/jboss/netty/handler/codec/spdy/i;
    ...
    invoke-interface {v2}, Lorg/jboss/netty/channel/Channel;->getPipeline()Lorg/jboss/netty/channel/ChannelPipeline;

    move-result-object v2

    new-instance v3, Lorg/jboss/netty/handler/codec/spdy/e;

    invoke-direct {v3, p0, p1, v0, v1}, Lorg/jboss/netty/handler/codec/spdy/e;-><init>(Lorg/jboss/netty/handler/codec/spdy/SpdyFrameEncoder;Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/MessageEvent;Lorg/jboss/netty/buffer/ChannelBuffer;)V

    invoke-interface {v2, v3}, Lorg/jboss/netty/channel/ChannelPipeline;->execute(Ljava/lang/Runnable;)Lorg/jboss/netty/channel/ChannelFuture;
    ...
    iget-object v7, p0, Lorg/jboss/netty/handler/codec/spdy/SpdyFrameEncoder;->headerBlockCompressor:Lorg/jboss/netty/handler/codec/spdy/i;
    ...
    new-instance v3, Lorg/jboss/netty/handler/codec/spdy/f;

    invoke-direct {v3, p0, p1, v0, v1}, Lorg/jboss/netty/handler/codec/spdy/f;-><init>(Lorg/jboss/netty/handler/codec/spdy/SpdyFrameEncoder;Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/MessageEvent;Lorg/jboss/netty/buffer/ChannelBuffer;)V
    ...
    new-instance v3, Lorg/jboss/netty/handler/codec/spdy/g;

    invoke-direct {v3, p0, p1, v0, v1}, Lorg/jboss/netty/handler/codec/spdy/g;-><init>(Lorg/jboss/netty/handler/codec/spdy/SpdyFrameEncoder;Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/MessageEvent;Lorg/jboss/netty/buffer/ChannelBuffer;)V
