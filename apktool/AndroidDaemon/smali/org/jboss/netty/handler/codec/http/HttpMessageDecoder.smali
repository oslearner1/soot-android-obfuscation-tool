...
.method private readFixedLengthContent(Lorg/jboss/netty/buffer/ChannelBuffer;)Ljava/lang/Object;
    ...
    invoke-interface {v1, v5}, Lorg/jboss/netty/handler/codec/http/HttpMessage;->setChunked(Z)V
    ...
    invoke-direct {p0, p1, v0}, Lorg/jboss/netty/handler/codec/http/HttpMessageDecoder;->read(Lorg/jboss/netty/buffer/ChannelBuffer;I)Lorg/jboss/netty/buffer/ChannelBuffer;
    ...
    invoke-interface {p1, v1}, Lorg/jboss/netty/buffer/ChannelBuffer;->readBytes(I)Lorg/jboss/netty/buffer/ChannelBuffer;
...
.method protected decode(Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/Channel;Lorg/jboss/netty/buffer/ChannelBuffer;Lorg/jboss/netty/handler/codec/http/HttpMessageDecoder$State;)Ljava/lang/Object;
    ...
    sget-object v0, Lorg/jboss/netty/handler/codec/http/i;->a:[I
    ...
    invoke-interface {v0, v6}, Lorg/jboss/netty/handler/codec/http/HttpMessage;->setChunked(Z)V
    ...
    invoke-static {v1, v8, v9}, Lorg/jboss/netty/handler/codec/http/HttpHeaders;->getContentLength(Lorg/jboss/netty/handler/codec/http/HttpMessage;J)J
    ...
    :cond_4
    sget-object v4, Lorg/jboss/netty/handler/codec/http/i;->a:[I
    ...
    invoke-static {v0, v8, v9}, Lorg/jboss/netty/handler/codec/http/HttpHeaders;->getContentLength(Lorg/jboss/netty/handler/codec/http/HttpMessage;J)J
    ...
    invoke-direct {v1, v5}, Lorg/jboss/netty/handler/codec/http/DefaultHttpChunk;-><init>(Lorg/jboss/netty/buffer/ChannelBuffer;)V
    ...
    iput-wide v4, p0, Lorg/jboss/netty/handler/codec/http/HttpMessageDecoder;->chunkSize:J
