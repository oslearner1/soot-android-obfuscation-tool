...
.method public handshake(Lorg/jboss/netty/channel/Channel;Lorg/jboss/netty/handler/codec/http/HttpRequest;)Lorg/jboss/netty/channel/ChannelFuture;
    ...
    invoke-interface {v5, v0}, Lorg/jboss/netty/buffer/ChannelBuffer;->writeInt(I)V

    invoke-interface {v5, v1}, Lorg/jboss/netty/buffer/ChannelBuffer;->writeInt(I)V

    invoke-interface {v5, v3, v4}, Lorg/jboss/netty/buffer/ChannelBuffer;->writeLong(J)V

    invoke-interface {v5}, Lorg/jboss/netty/buffer/ChannelBuffer;->array()[B

    move-result-object v0

    invoke-static {v0}, Lorg/jboss/netty/handler/codec/http/websocketx/e;->a([B)[B
    ...
    const-class v1, Lorg/jboss/netty/handler/codec/http/HttpChunkAggregator;
    ...
    invoke-interface {v0, v1}, Lorg/jboss/netty/channel/ChannelPipeline;->remove(Ljava/lang/Class;)Lorg/jboss/netty/channel/ChannelHandler;

    :cond_8
    const-class v1, Lorg/jboss/netty/handler/codec/http/HttpRequestDecoder;

    const-string v3, "wsdecoder"

    new-instance v4, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket00FrameDecoder;

    invoke-virtual {p0}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker00;->getMaxFramePayloadLength()J

    move-result-wide v5

    invoke-direct {v4, v5, v6}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket00FrameDecoder;-><init>(J)V

    invoke-interface {v0, v1, v3, v4}, Lorg/jboss/netty/channel/ChannelPipeline;->replace(Ljava/lang/Class;Ljava/lang/String;Lorg/jboss/netty/channel/ChannelHandler;)Lorg/jboss/netty/channel/ChannelHandler;
    ...
    invoke-interface {v0, v2, v3, v4}, Lorg/jboss/netty/channel/ChannelPipeline;->replace(Ljava/lang/Class;Ljava/lang/String;Lorg/jboss/netty/channel/ChannelHandler;)Lorg/jboss/netty/channel/ChannelHandler;
