...
.method private createSynReplyFrame(Lorg/jboss/netty/handler/codec/http/HttpResponse;)Lorg/jboss/netty/handler/codec/spdy/SpdySynReplyFrame;
    ...
    invoke-static {v0, v2, v1}, Lorg/jboss/netty/handler/codec/spdy/SpdyHeaders;->setStatus(ILorg/jboss/netty/handler/codec/spdy/SpdyHeaderBlock;Lorg/jboss/netty/handler/codec/http/HttpResponseStatus;)V
    ...
    invoke-static {v0, v2, v1}, Lorg/jboss/netty/handler/codec/spdy/SpdyHeaders;->setVersion(ILorg/jboss/netty/handler/codec/spdy/SpdyHeaderBlock;Lorg/jboss/netty/handler/codec/http/HttpVersion;)V
    ...
    invoke-interface {v2, v1, v0}, Lorg/jboss/netty/handler/codec/spdy/SpdySynReplyFrame;->addHeader(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :goto_2
    invoke-interface {v1, v0}, Lorg/jboss/netty/handler/codec/spdy/SpdySynReplyFrame;->setLast(Z)V
...
.method private createSynStreamFrame(Lorg/jboss/netty/handler/codec/http/HttpMessage;)Lorg/jboss/netty/handler/codec/spdy/SpdySynStreamFrame;
    ...
    invoke-interface {p1, v2}, Lorg/jboss/netty/handler/codec/http/HttpMessage;->removeHeader(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v5, v0, v6}, Lorg/jboss/netty/handler/codec/spdy/DefaultSpdySynStreamFrame;-><init>(IIB)V
    ...
    invoke-static {v6, v2, v8}, Lorg/jboss/netty/handler/codec/spdy/SpdyHeaders;->setMethod(ILorg/jboss/netty/handler/codec/spdy/SpdyHeaderBlock;Lorg/jboss/netty/handler/codec/http/HttpMethod;)V
    ...
    invoke-static {v6, v2, v0}, Lorg/jboss/netty/handler/codec/spdy/SpdyHeaders;->setUrl(ILorg/jboss/netty/handler/codec/spdy/SpdyHeaderBlock;Ljava/lang/String;)V
    ...
    invoke-static {v0, v2, v6}, Lorg/jboss/netty/handler/codec/spdy/SpdyHeaders;->setVersion(ILorg/jboss/netty/handler/codec/spdy/SpdyHeaderBlock;Lorg/jboss/netty/handler/codec/http/HttpVersion;)V
    ...
    invoke-static {v6, v2, v0}, Lorg/jboss/netty/handler/codec/spdy/SpdyHeaders;->setStatus(ILorg/jboss/netty/handler/codec/spdy/SpdyHeaderBlock;Lorg/jboss/netty/handler/codec/http/HttpResponseStatus;)V

    iget v0, p0, Lorg/jboss/netty/handler/codec/spdy/SpdyHttpEncoder;->spdyVersion:I

    invoke-static {v0, v2, v7}, Lorg/jboss/netty/handler/codec/spdy/SpdyHeaders;->setUrl(ILorg/jboss/netty/handler/codec/spdy/SpdyHeaderBlock;Ljava/lang/String;)V
    ...
    invoke-static {v2, v0}, Lorg/jboss/netty/handler/codec/spdy/SpdyHeaders;->setHost(Lorg/jboss/netty/handler/codec/spdy/SpdyHeaderBlock;Ljava/lang/String;)V
    ...
    invoke-static {v1, v2, v0}, Lorg/jboss/netty/handler/codec/spdy/SpdyHeaders;->setScheme(ILorg/jboss/netty/handler/codec/spdy/SpdyHeaderBlock;Ljava/lang/String;)V
    ...
    invoke-interface {v2, v0, v1}, Lorg/jboss/netty/handler/codec/spdy/SpdySynStreamFrame;->addHeader(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :goto_3
    invoke-interface {v1, v0}, Lorg/jboss/netty/handler/codec/spdy/SpdySynStreamFrame;->setLast(Z)V
...
.method private getContentFuture(Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/MessageEvent;ILorg/jboss/netty/handler/codec/http/HttpMessage;)Lorg/jboss/netty/channel/ChannelFuture;
    ...
    invoke-direct {v1, p3}, Lorg/jboss/netty/handler/codec/spdy/DefaultSpdyDataFrame;-><init>(I)V
    ...
    new-instance v2, Lorg/jboss/netty/handler/codec/spdy/o;

    invoke-direct {v2, p0, p1, p2, v1}, Lorg/jboss/netty/handler/codec/spdy/o;-><init>(Lorg/jboss/netty/handler/codec/spdy/SpdyHttpEncoder;Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/MessageEvent;Ljava/lang/Object;)V
...
.method public handleDownstream(Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/ChannelEvent;)V
    ...
    invoke-direct {p0, p1, v0, v3, v1}, Lorg/jboss/netty/handler/codec/spdy/SpdyHttpEncoder;->getContentFuture(Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/MessageEvent;ILorg/jboss/netty/handler/codec/http/HttpMessage;)Lorg/jboss/netty/channel/ChannelFuture;
    ...
    invoke-direct {v2, p0, p1, v0, v3}, Lorg/jboss/netty/handler/codec/spdy/o;-><init>(Lorg/jboss/netty/handler/codec/spdy/SpdyHttpEncoder;Lorg/jboss/netty/channel/ChannelHandlerContext;Lorg/jboss/netty/channel/MessageEvent;Ljava/lang/Object;)V
