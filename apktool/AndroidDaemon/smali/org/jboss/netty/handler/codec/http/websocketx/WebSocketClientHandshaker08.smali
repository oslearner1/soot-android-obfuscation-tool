...
.method public finishHandshake(Lorg/jboss/netty/channel/Channel;Lorg/jboss/netty/handler/codec/http/HttpResponse;)V
    ...
    iget-object v1, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker08;->expectedChallengeResponseString:Ljava/lang/String;
    ...
    iget-object v4, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker08;->expectedChallengeResponseString:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker08;->setActualSubprotocol(Ljava/lang/String;)V
    ...
    new-instance v2, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameDecoder;

    iget-boolean v3, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker08;->allowExtensions:Z

    invoke-virtual {p0}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker08;->getMaxFramePayloadLength()J

    move-result-wide v4

    invoke-direct {v2, v6, v3, v4, v5}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameDecoder;-><init>(ZZJ)V
...
.method public handshake(Lorg/jboss/netty/channel/Channel;)Lorg/jboss/netty/channel/ChannelFuture;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker08;->getWebSocketUrl()Ljava/net/URI;
    ...
    invoke-static {v2}, Lorg/jboss/netty/handler/codec/http/websocketx/e;->a(I)[B
    ...
    invoke-static {v3}, Lorg/jboss/netty/handler/codec/http/websocketx/e;->b([B)[B

    move-result-object v3

    invoke-static {v3}, Lorg/jboss/netty/handler/codec/http/websocketx/e;->c([B)Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker08;->expectedChallengeResponseString:Ljava/lang/String;

    sget-object v3, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker08;->logger:Lorg/jboss/netty/logging/InternalLogger;
    ...
    const-string v4, "WS Version 08 Client Handshake key: %s. Expected response: %s."
    ...
    iget-object v6, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker08;->expectedChallengeResponseString:Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker08;->getExpectedSubprotocol()Ljava/lang/String;
    ...
    iget-object v0, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker08;->customHeaders:Ljava/util/Map;
    ...
    iget-object v2, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketClientHandshaker08;->customHeaders:Ljava/util/Map;
    ...
    invoke-direct {v4, v7}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameEncoder;-><init>(Z)V
