...
.method public handshake(Lorg/jboss/netty/channel/Channel;Lorg/jboss/netty/handler/codec/http/HttpRequest;)Lorg/jboss/netty/channel/ChannelFuture;
    ...
    const-string v1, "Channel %s WS Version 8 server handshake"
    ...
    sget-object v3, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->logger:Lorg/jboss/netty/logging/InternalLogger;
    ...
    const-string v4, "WS Version 8 Server Handshake key: %s. Response: %s."
    ...
    invoke-virtual {p0, v1}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->selectSubprotocol(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v2}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->setSelectedSubprotocol(Ljava/lang/String;)V
    ...
    new-instance v4, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameDecoder;

    iget-boolean v5, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->allowExtensions:Z

    invoke-virtual {p0}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->getMaxFramePayloadLength()J

    move-result-wide v6

    invoke-direct {v4, v9, v5, v6, v7}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameDecoder;-><init>(ZZJ)V
    ...
    invoke-direct {v4, v8}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameEncoder;-><init>(Z)V
