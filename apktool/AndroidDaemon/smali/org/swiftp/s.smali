...
.method public constructor <init>(Lorg/swiftp/SessionThread;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lorg/swiftp/s;->a:Ljava/lang/String;
...
.method public run()V
    ...
    iget-object v0, p0, Lorg/swiftp/s;->c:Lorg/swiftp/af;

    const-string v1, "RETR executing"

    invoke-virtual {v0, v12, v1}, Lorg/swiftp/af;->l(ILjava/lang/String;)V

    iget-object v0, p0, Lorg/swiftp/s;->a:Ljava/lang/String;

    invoke-static {v0}, Lorg/swiftp/s;->getParameter(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const/4 v2, 0x0

    iget-object v1, p0, Lorg/swiftp/s;->b:Lorg/swiftp/SessionThread;

    invoke-virtual {v1}, Lorg/swiftp/SessionThread;->getWorkingDir()Ljava/io/File;

    move-result-object v1

    invoke-static {v1, v0}, Lorg/swiftp/s;->inputPathToChrootedFile(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v0

    invoke-virtual {p0, v0}, Lorg/swiftp/s;->violatesChroot(Ljava/io/File;)Z
    ...
    iget-object v1, p0, Lorg/swiftp/s;->c:Lorg/swiftp/af;
    ...
    invoke-static {}, Lorg/swiftp/ac;->getDataChunkSize()I

    move-result v0

    new-array v7, v0, [B

    iget-object v0, p0, Lorg/swiftp/s;->b:Lorg/swiftp/SessionThread;
    ...
    invoke-virtual {v0, v1, v4}, Lorg/swiftp/af;->l(ILjava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v3}, Lorg/swiftp/af;->l(ILjava/lang/String;)V
    ...
    invoke-virtual {v1, v7, v0}, Lorg/swiftp/SessionThread;->sendViaDataSocket([BI)Z
    ...
    iget-object v4, p0, Lorg/swiftp/s;->b:Lorg/swiftp/SessionThread;

    sub-int/2addr v1, v0

    invoke-virtual {v4, v7, v0, v1}, Lorg/swiftp/SessionThread;->sendViaDataSocket([BII)Z
    ...
    iget-object v10, p0, Lorg/swiftp/s;->b:Lorg/swiftp/SessionThread;

    sub-int v11, v1, v0

    invoke-virtual {v10, v7, v0, v11}, Lorg/swiftp/SessionThread;->sendViaDataSocket([BII)Z
    ...
    invoke-virtual {v0, v9, v10}, Lorg/swiftp/SessionThread;->sendViaDataSocket([BI)Z
