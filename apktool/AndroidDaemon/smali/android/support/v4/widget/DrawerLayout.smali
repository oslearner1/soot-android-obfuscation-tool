...
# static fields
.field private static I:Landroid/support/v4/widget/n;
...
.field private final d:Landroid/support/v4/widget/m;
...
.field private final j:Landroid/support/v4/widget/bf;

.field private final k:Landroid/support/v4/widget/bf;

.field private final l:Landroid/support/v4/widget/s;

.field private final m:Landroid/support/v4/widget/s;
...
.field private t:Landroid/support/v4/widget/q;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->I:Landroid/support/v4/widget/n;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/m;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/m;
    ...
    new-instance v2, Landroid/support/v4/widget/s;

    const/4 v3, 0x3

    invoke-direct {v2, p0, v3}, Landroid/support/v4/widget/s;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/s;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/s;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/s;

    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/bf;->create(Landroid/view/ViewGroup;FLandroid/support/v4/widget/bi;)Landroid/support/v4/widget/bf;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bf;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bf;

    invoke-virtual {v2, v4}, Landroid/support/v4/widget/bf;->setEdgeTrackingEnabled(I)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bf;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/bf;->setMinVelocity(F)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/s;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bf;

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/s;->setDragger(Landroid/support/v4/widget/bf;)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/s;

    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/bf;->create(Landroid/view/ViewGroup;FLandroid/support/v4/widget/bi;)Landroid/support/v4/widget/bf;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bf;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bf;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/bf;->setEdgeTrackingEnabled(I)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bf;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/bf;->setMinVelocity(F)V

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/s;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bf;

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/s;->setDragger(Landroid/support/v4/widget/bf;)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/widget/l;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    invoke-static {p0, v1}, Landroid/support/v4/view/av;->setAccessibilityDelegate(Landroid/view/View;Landroid/support/v4/view/a;)V

    const/4 v1, 0x0

    invoke-static {p0, v1}, Landroid/support/v4/view/bo;->setMotionEventSplittingEnabled(Landroid/view/ViewGroup;Z)V

    invoke-static {p0}, Landroid/support/v4/view/av;->getFitsSystemWindows(Landroid/view/View;)Z

    move-result v1

    if-eqz v1, :cond_0

    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->I:Landroid/support/v4/widget/n;

    invoke-interface {v1, p0}, Landroid/support/v4/widget/n;->configureApplyInsets(Landroid/view/View;)V

    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->I:Landroid/support/v4/widget/n;

    invoke-interface {v1, p1}, Landroid/support/v4/widget/n;->getDefaultStatusBarBackground(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->H:Ljava/util/ArrayList;
...
.method private a(Z)V
    ...
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bf;
    ...
    invoke-virtual {v7, v5, v6, v8}, Landroid/support/v4/widget/bf;->smoothSlideViewTo(Landroid/view/View;II)Z
    ...
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bf;
    ...
    invoke-virtual {v6, v5, v7, v8}, Landroid/support/v4/widget/bf;->smoothSlideViewTo(Landroid/view/View;II)Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/s;->removeCallbacks()V

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/s;
...
.method private static a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-static {p0}, Landroid/support/v4/a/a/a;->isAutoMirrored(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_1
    invoke-static {p0, p1}, Landroid/support/v4/a/a/a;->setLayoutDirection(Landroid/graphics/drawable/Drawable;I)V
...
.method static c(Landroid/view/View;)Z
    ...
    invoke-static {v0, v1}, Landroid/support/v4/view/i;->getAbsoluteGravity(II)I
...
.method static synthetic d(Landroid/view/View;)Z
    .locals 2
...
.method final a(I)Landroid/view/View;
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/i;->getAbsoluteGravity(II)I
...
.method final a(ILandroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bf;

    invoke-virtual {v1}, Landroid/support/v4/widget/bf;->getViewDragState()I

    move-result v1

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bf;

    invoke-virtual {v4}, Landroid/support/v4/widget/bf;->getViewDragState()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/q;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/q;

    invoke-interface {v0, p2}, Landroid/support/v4/widget/q;->onDrawerClosed(Landroid/view/View;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/widget/q;->onDrawerStateChanged(I)V
    ...
    invoke-interface {v0, p2}, Landroid/support/v4/widget/q;->onDrawerOpened(Landroid/view/View;)V
...
.method final a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/widget/q;->onDrawerSlide(Landroid/view/View;F)V
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    :cond_2
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->H:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->H:Ljava/util/ArrayList;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/av;->setImportantForAccessibility(Landroid/view/View;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/m;

    invoke-static {p1, v0}, Landroid/support/v4/view/av;->setAccessibilityDelegate(Landroid/view/View;Landroid/support/v4/view/a;)V
...
.method public closeDrawer(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bf;
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/support/v4/widget/bf;->smoothSlideViewTo(Landroid/view/View;II)Z

    goto :goto_0

    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bf;
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/bf;->continueSettling(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bf;

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/bf;->continueSettling(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/bf;->getEdgeSize()I
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bf;

    invoke-virtual {v3}, Landroid/support/v4/widget/bf;->getEdgeSize()I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->I:Landroid/support/v4/widget/n;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->B:Ljava/lang/Object;

    invoke-interface {v0, v1}, Landroid/support/v4/widget/n;->getTopInset(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v4, p1}, Landroid/support/v4/widget/bf;->shouldInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bf;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/bf;->findTopChildUnder(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/bf;->checkTouchSlop(I)Z
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-static {p2}, Landroid/support/v4/view/m;->startTracking(Landroid/view/KeyEvent;)V
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {v8}, Landroid/support/v4/widget/DrawerLayout;->e(Landroid/view/View;)Z
...
.method protected onMeasure(II)V
    ...
    invoke-static {v8, v5}, Landroid/support/v4/view/i;->getAbsoluteGravity(II)I

    move-result v8

    invoke-static {v7}, Landroid/support/v4/view/av;->getFitsSystemWindows(Landroid/view/View;)Z

    move-result v9

    if-eqz v9, :cond_6

    sget-object v9, Landroid/support/v4/widget/DrawerLayout;->I:Landroid/support/v4/widget/n;

    iget-object v10, p0, Landroid/support/v4/widget/DrawerLayout;->B:Ljava/lang/Object;

    invoke-interface {v9, v7, v10, v8}, Landroid/support/v4/widget/n;->dispatchChildInsets(Landroid/view/View;Ljava/lang/Object;I)V

    :cond_2
    :goto_3
    invoke-static {v7}, Landroid/support/v4/widget/DrawerLayout;->e(Landroid/view/View;)Z
    ...
    invoke-interface {v9, v0, v10, v8}, Landroid/support/v4/widget/n;->applyMarginInsets(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    invoke-static {v7}, Landroid/support/v4/view/av;->getElevation(Landroid/view/View;)F
    ...
    invoke-static {v7, v8}, Landroid/support/v4/view/av;->setElevation(Landroid/view/View;F)V

    :cond_8
    invoke-virtual {p0, v7}, Landroid/support/v4/widget/DrawerLayout;->b(Landroid/view/View;)I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v2, p1}, Landroid/support/v4/widget/bf;->processTouchEvent(Landroid/view/MotionEvent;)V
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bf;

    float-to-int v5, v2

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/bf;->findTopChildUnder(II)Landroid/view/View;
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v1, v2}, Landroid/support/v4/view/av;->setElevation(Landroid/view/View;F)V
...
.method public setDrawerListener(Landroid/support/v4/widget/q;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/q;
...
.method public setDrawerLockMode(II)V
    ...
    invoke-static {p2, v0}, Landroid/support/v4/view/i;->getAbsoluteGravity(II)I
...
.method public setDrawerLockMode(ILandroid/view/View;)V
    ...
    invoke-static {p2}, Landroid/support/v4/widget/DrawerLayout;->c(Landroid/view/View;)Z
...
.method public setDrawerTitle(ILjava/lang/CharSequence;)V
    ...
    iput-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->z:Ljava/lang/CharSequence;
...
.method public setStatusBarBackground(I)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/content/e;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
