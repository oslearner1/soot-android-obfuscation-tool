...
.method public constructor <init>(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v2, v1}, Landroid/support/v4/widget/a;->setMaximumVelocity(FF)Landroid/support/v4/widget/a;

    int-to-float v1, v0

    int-to-float v0, v0

    invoke-virtual {p0, v1, v0}, Landroid/support/v4/widget/a;->setMinimumVelocity(FF)Landroid/support/v4/widget/a;

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Landroid/support/v4/widget/a;->setEdgeType(I)Landroid/support/v4/widget/a;

    invoke-virtual {p0, v6, v6}, Landroid/support/v4/widget/a;->setMaximumEdges(FF)Landroid/support/v4/widget/a;

    invoke-virtual {p0, v3, v3}, Landroid/support/v4/widget/a;->setRelativeEdges(FF)Landroid/support/v4/widget/a;

    invoke-virtual {p0, v5, v5}, Landroid/support/v4/widget/a;->setRelativeVelocity(FF)Landroid/support/v4/widget/a;

    sget v0, Landroid/support/v4/widget/a;->r:I

    invoke-virtual {p0, v0}, Landroid/support/v4/widget/a;->setActivationDelay(I)Landroid/support/v4/widget/a;

    const/16 v0, 0x1f4

    invoke-virtual {p0, v0}, Landroid/support/v4/widget/a;->setRampUpDuration(I)Landroid/support/v4/widget/a;

    const/16 v0, 0x1f4

    invoke-virtual {p0, v0}, Landroid/support/v4/widget/a;->setRampDownDuration(I)Landroid/support/v4/widget/a;
...
.method private a()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/b;->getVerticalDirection()I

    move-result v1

    invoke-virtual {v0}, Landroid/support/v4/widget/b;->getHorizontalDirection()I
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/a;->canTargetScrollHorizontally(I)Z
...
.method private b()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/b;->requestStop()V
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    invoke-static {p2}, Landroid/support/v4/view/y;->getActionMasked(Landroid/view/MotionEvent;)I
    ...
    invoke-virtual {v4, v2, v3}, Landroid/support/v4/widget/b;->setTargetVelocity(FF)V
    ...
    invoke-static {v2, v3, v4, v5}, Landroid/support/v4/view/av;->postOnAnimationDelayed(Landroid/view/View;Ljava/lang/Runnable;J)V
...
.method public setActivationDelay(I)Landroid/support/v4/widget/a;
    .locals 0
...
.method public setEdgeType(I)Landroid/support/v4/widget/a;
    .locals 0
...
.method public setEnabled(Z)Landroid/support/v4/widget/a;
    .locals 1
...
.method public setExclusive(Z)Landroid/support/v4/widget/a;
    .locals 0
...
.method public setMaximumEdges(FF)Landroid/support/v4/widget/a;
    .locals 2
...
.method public setMaximumVelocity(FF)Landroid/support/v4/widget/a;
    .locals 4
...
.method public setMinimumVelocity(FF)Landroid/support/v4/widget/a;
    .locals 4
...
.method public setRampDownDuration(I)Landroid/support/v4/widget/a;
    .locals 1

    iget-object v0, p0, Landroid/support/v4/widget/a;->a:Landroid/support/v4/widget/b;

    invoke-virtual {v0, p1}, Landroid/support/v4/widget/b;->setRampDownDuration(I)V

    return-object p0
.end method

.method public setRampUpDuration(I)Landroid/support/v4/widget/a;
    .locals 1

    iget-object v0, p0, Landroid/support/v4/widget/a;->a:Landroid/support/v4/widget/b;

    invoke-virtual {v0, p1}, Landroid/support/v4/widget/b;->setRampUpDuration(I)V

    return-object p0
.end method

.method public setRelativeEdges(FF)Landroid/support/v4/widget/a;
    .locals 2
...
.method public setRelativeVelocity(FF)Landroid/support/v4/widget/a;
    .locals 4
