...
.field private f:Landroid/support/v4/widget/h;

.field private g:Landroid/database/DataSetObserver;

.field private h:Landroid/support/v4/widget/j;

.field private i:Landroid/widget/FilterQueryProvider;
...
.method private a(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    iput-boolean v0, p0, Landroid/support/v4/widget/CursorAdapter;->c:Z

    :goto_0
    if-eqz p2, :cond_3

    :goto_1
    iput-object p2, p0, Landroid/support/v4/widget/CursorAdapter;->b:Landroid/database/Cursor;
    ...
    :goto_2
    iput v2, p0, Landroid/support/v4/widget/CursorAdapter;->e:I
    ...
    invoke-direct {v2, p0}, Landroid/support/v4/widget/h;-><init>(Landroid/support/v4/widget/CursorAdapter;)V

    iput-object v2, p0, Landroid/support/v4/widget/CursorAdapter;->f:Landroid/support/v4/widget/h;

    new-instance v2, Landroid/support/v4/widget/i;

    invoke-direct {v2, p0, v1}, Landroid/support/v4/widget/i;-><init>(Landroid/support/v4/widget/CursorAdapter;B)V

    iput-object v2, p0, Landroid/support/v4/widget/CursorAdapter;->g:Landroid/database/DataSetObserver;

    :goto_3
    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->f:Landroid/support/v4/widget/h;
    ...
    :cond_2
    iput-boolean v1, p0, Landroid/support/v4/widget/CursorAdapter;->c:Z
    ...
    :cond_5
    iput-object v4, p0, Landroid/support/v4/widget/CursorAdapter;->f:Landroid/support/v4/widget/h;

    iput-object v4, p0, Landroid/support/v4/widget/CursorAdapter;->g:Landroid/database/DataSetObserver;
...
.method protected final a()V
    ...
    iget-boolean v0, p0, Landroid/support/v4/widget/CursorAdapter;->c:Z
...
.method public getFilter()Landroid/widget/Filter;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->h:Landroid/support/v4/widget/j;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v4/widget/j;

    invoke-direct {v0, p0}, Landroid/support/v4/widget/j;-><init>(Landroid/support/v4/widget/k;)V

    iput-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->h:Landroid/support/v4/widget/j;
...
.method public setFilterQueryProvider(Landroid/widget/FilterQueryProvider;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/CursorAdapter;->i:Landroid/widget/FilterQueryProvider;
...
.method public swapCursor(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/CursorAdapter;->f:Landroid/support/v4/widget/h;
