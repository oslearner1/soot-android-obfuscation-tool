...
.method public onNestedFling(Landroid/view/ViewParent;Landroid/view/View;FFZ)Z
    ...
    invoke-interface {p1, p2, p3, p4, p5}, Landroid/support/v4/view/af;->onNestedFling(Landroid/view/View;FFZ)Z
...
.method public onNestedPreFling(Landroid/view/ViewParent;Landroid/view/View;FF)Z
    ...
    invoke-interface {p1, p2, p3, p4}, Landroid/support/v4/view/af;->onNestedPreFling(Landroid/view/View;FF)Z
...
.method public onNestedPreScroll(Landroid/view/ViewParent;Landroid/view/View;II[I)V
    ...
    invoke-interface {p1, p2, p3, p4, p5}, Landroid/support/v4/view/af;->onNestedPreScroll(Landroid/view/View;II[I)V
...
.method public onNestedScroll(Landroid/view/ViewParent;Landroid/view/View;IIII)V
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/v4/view/af;->onNestedScroll(Landroid/view/View;IIII)V
...
.method public onNestedScrollAccepted(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-interface {p1, p2, p3, p4}, Landroid/support/v4/view/af;->onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
...
.method public onStartNestedScroll(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;I)Z
    ...
    invoke-interface {p1, p2, p3, p4}, Landroid/support/v4/view/af;->onStartNestedScroll(Landroid/view/View;Landroid/view/View;I)Z
...
.method public onStopNestedScroll(Landroid/view/ViewParent;Landroid/view/View;)V
    ...
    invoke-interface {p1, p2}, Landroid/support/v4/view/af;->onStopNestedScroll(Landroid/view/View;)V
