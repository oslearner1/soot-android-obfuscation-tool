...
.field private static final q:Landroid/support/v4/view/al;
...
.field private final l:Landroid/support/v4/view/ak;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/PagerTitleStrip;->q:Landroid/support/v4/view/al;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, p0, v0}, Landroid/support/v4/view/ak;-><init>(Landroid/support/v4/view/PagerTitleStrip;B)V

    iput-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Landroid/support/v4/view/ak;
...
.method private static setSingleLineAllCaps(Landroid/widget/TextView;)V
    ...
    sget-object v0, Landroid/support/v4/view/PagerTitleStrip;->q:Landroid/support/v4/view/al;

    invoke-interface {v0, p0}, Landroid/support/v4/view/al;->setSingleLineAllCaps(Landroid/widget/TextView;)V
...
.method a(IFZ)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/ViewPager;->getAdapter()Landroid/support/v4/view/ah;
...
.method final a(ILandroid/support/v4/view/ah;)V
    ...
    invoke-virtual {p2}, Landroid/support/v4/view/ah;->getCount()I
    ...
    invoke-virtual {p2, v2}, Landroid/support/v4/view/ah;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, p1}, Landroid/support/v4/view/ah;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/view/ah;->getPageTitle(I)Ljava/lang/CharSequence;
...
.method final a(Landroid/support/v4/view/ah;Landroid/support/v4/view/ah;)V
    ...
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Landroid/support/v4/view/ak;

    invoke-virtual {p1, v0}, Landroid/support/v4/view/ah;->unregisterDataSetObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/view/ah;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/ViewPager;->getAdapter()Landroid/support/v4/view/ah;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Landroid/support/v4/view/ak;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->a(Landroid/support/v4/view/cb;)Landroid/support/v4/view/cb;

    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Landroid/support/v4/view/ak;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->setOnAdapterChangeListener(Landroid/support/v4/view/ca;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/support/v4/view/cb;)Landroid/support/v4/view/cb;

    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->a:Landroid/support/v4/view/ViewPager;

    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->setOnAdapterChangeListener(Landroid/support/v4/view/ca;)V
...
.method protected onMeasure(II)V
    ...
    invoke-static {v1}, Landroid/support/v4/view/av;->getMeasuredState(Landroid/view/View;)I

    move-result v1

    shl-int/lit8 v1, v1, 0x10

    invoke-static {v0, p2, v1}, Landroid/support/v4/view/av;->resolveSizeAndState(III)I
