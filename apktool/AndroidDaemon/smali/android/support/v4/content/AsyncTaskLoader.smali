...
.field private volatile c:Landroid/support/v4/content/a;

.field private volatile d:Landroid/support/v4/content/a;
...
.method private constructor <init>(Landroid/content/Context;Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/content/g;-><init>(Landroid/content/Context;)V

    const-wide/16 v0, -0x2710

    iput-wide v0, p0, Landroid/support/v4/content/AsyncTaskLoader;->f:J

    iput-object p2, p0, Landroid/support/v4/content/AsyncTaskLoader;->b:Ljava/util/concurrent/Executor;
...
.method protected final a()V
    ...
    invoke-super {p0}, Landroid/support/v4/content/g;->a()V
...
.method final b(Landroid/support/v4/content/a;Ljava/lang/Object;)V
    .locals 2
...
.method protected final b()Z
    ...
    iget-boolean v1, v1, Landroid/support/v4/content/a;->a:Z

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/v4/content/AsyncTaskLoader;->c:Landroid/support/v4/content/a;

    iput-boolean v0, v1, Landroid/support/v4/content/a;->a:Z
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/content/a;->cancel(Z)Z
...
.method final c()V
    ...
    iget-boolean v0, v0, Landroid/support/v4/content/a;->a:Z
    ...
    iput-boolean v1, v0, Landroid/support/v4/content/a;->a:Z
    ...
    iget-object v1, p0, Landroid/support/v4/content/AsyncTaskLoader;->b:Ljava/util/concurrent/Executor;

    const/4 v2, 0x0

    invoke-virtual {v0, v1, v2}, Landroid/support/v4/content/a;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/support/v4/content/ModernAsyncTask;
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Landroid/support/v4/content/g;->dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p3}, Landroid/support/v4/util/l;->formatDuration(JLjava/io/PrintWriter;)V
    ...
    invoke-static {v0, v1, v2, v3, p3}, Landroid/support/v4/util/l;->formatDuration(JJLjava/io/PrintWriter;)V
...
.method public waitForLoader()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/a;->waitForLoader()V
