...
.field private d:Landroid/support/v4/app/ad;

.field private e:I

.field private f:Landroid/widget/TabHost$OnTabChangeListener;

.field private g:Landroid/support/v4/app/at;
...
.method private a(Ljava/lang/String;Landroid/support/v4/app/au;)Landroid/support/v4/app/au;
    .locals 4
    ...
    invoke-static {v0}, Landroid/support/v4/app/at;->b(Landroid/support/v4/app/at;)Ljava/lang/String;
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->g:Landroid/support/v4/app/at;

    if-eq v0, v1, :cond_5

    if-nez p2, :cond_2

    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/ad;
    ...
    invoke-static {v0}, Landroid/support/v4/app/at;->a(Landroid/support/v4/app/at;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/app/au;->detach(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/au;

    :cond_3
    if-eqz v1, :cond_4

    invoke-static {v1}, Landroid/support/v4/app/at;->a(Landroid/support/v4/app/at;)Landroid/support/v4/app/Fragment;
    ...
    invoke-static {v1}, Landroid/support/v4/app/at;->c(Landroid/support/v4/app/at;)Ljava/lang/Class;
    ...
    invoke-static {v1}, Landroid/support/v4/app/at;->d(Landroid/support/v4/app/at;)Landroid/os/Bundle;
    ...
    invoke-static {v1, v0}, Landroid/support/v4/app/at;->a(Landroid/support/v4/app/at;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    invoke-static {v1}, Landroid/support/v4/app/at;->b(Landroid/support/v4/app/at;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p2, v0, v2, v3}, Landroid/support/v4/app/au;->add(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/au;

    :cond_4
    :goto_2
    iput-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->g:Landroid/support/v4/app/at;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/app/au;->attach(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/au;
...
.method public addTab(Landroid/widget/TabHost$TabSpec;Ljava/lang/Class;Landroid/os/Bundle;)V
    ...
    invoke-direct {v1, v0, p2, p3}, Landroid/support/v4/app/at;-><init>(Ljava/lang/String;Ljava/lang/Class;Landroid/os/Bundle;)V

    iget-boolean v2, p0, Landroid/support/v4/app/FragmentTabHost;->h:Z

    if-eqz v2, :cond_0

    iget-object v2, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/ad;

    invoke-virtual {v2, v0}, Landroid/support/v4/app/ad;->findFragmentByTag(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/au;->detach(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/au;
...
.method protected onAttachedToWindow()V
    ...
    iget-object v4, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/ad;

    invoke-static {v0}, Landroid/support/v4/app/at;->b(Landroid/support/v4/app/at;)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v4, v5}, Landroid/support/v4/app/ad;->findFragmentByTag(Ljava/lang/String;)Landroid/support/v4/app/Fragment;

    move-result-object v4

    invoke-static {v0, v4}, Landroid/support/v4/app/at;->a(Landroid/support/v4/app/at;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->g:Landroid/support/v4/app/at;
    ...
    iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/ad;

    invoke-virtual {v1}, Landroid/support/v4/app/ad;->beginTransaction()Landroid/support/v4/app/au;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/app/au;->detach(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/au;
    ...
    invoke-direct {p0, v3, v1}, Landroid/support/v4/app/FragmentTabHost;->a(Ljava/lang/String;Landroid/support/v4/app/au;)Landroid/support/v4/app/au;
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/ad;->executePendingTransactions()Z
...
.method public onTabChanged(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v4/app/FragmentTabHost;->a(Ljava/lang/String;Landroid/support/v4/app/au;)Landroid/support/v4/app/au;
...
.method public setup(Landroid/content/Context;Landroid/support/v4/app/ad;)V
    .locals 0
    ...
    iput-object p2, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/ad;
...
.method public setup(Landroid/content/Context;Landroid/support/v4/app/ad;I)V
    .locals 2
