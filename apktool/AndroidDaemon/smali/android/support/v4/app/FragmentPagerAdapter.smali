...
.method public constructor <init>(Landroid/support/v4/app/ad;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentPagerAdapter;->b:Landroid/support/v4/app/au;

    iput-object v0, p0, Landroid/support/v4/app/FragmentPagerAdapter;->c:Landroid/support/v4/app/Fragment;

    iput-object p1, p0, Landroid/support/v4/app/FragmentPagerAdapter;->a:Landroid/support/v4/app/ad;
...
.method public destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/FragmentPagerAdapter;->b:Landroid/support/v4/app/au;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/app/FragmentPagerAdapter;->a:Landroid/support/v4/app/ad;
    ...
    invoke-virtual {v0, p3}, Landroid/support/v4/app/au;->detach(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/au;
...
.method public instantiateItem(Landroid/view/ViewGroup;I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroid/support/v4/app/FragmentPagerAdapter;->a:Landroid/support/v4/app/ad;

    invoke-virtual {v3, v0}, Landroid/support/v4/app/ad;->findFragmentByTag(Ljava/lang/String;)Landroid/support/v4/app/Fragment;

    move-result-object v0

    if-eqz v0, :cond_2

    iget-object v1, p0, Landroid/support/v4/app/FragmentPagerAdapter;->b:Landroid/support/v4/app/au;

    invoke-virtual {v1, v0}, Landroid/support/v4/app/au;->attach(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/au;
    ...
    iget-object v3, p0, Landroid/support/v4/app/FragmentPagerAdapter;->b:Landroid/support/v4/app/au;
    ...
    invoke-virtual {v3, v4, v0, v1}, Landroid/support/v4/app/au;->add(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/au;
