...
.field private final c:Landroid/support/v4/media/routing/d;
...
.field private i:Landroid/support/v4/app/f;
...
.method public constructor <init>(Landroid/app/Activity;Landroid/support/v4/widget/DrawerLayout;ZIII)V
    ...
    invoke-interface {v0}, Landroid/support/v4/app/e;->getDrawerToggleDelegate$68805b40()Landroid/support/v4/media/routing/d;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/ActionBarDrawerToggle;->c:Landroid/support/v4/media/routing/d;
    ...
    invoke-static {p1, p4}, Landroid/support/v4/content/e;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, p0, v1, v2}, Landroid/support/v4/app/f;-><init>(Landroid/support/v4/app/ActionBarDrawerToggle;Landroid/graphics/drawable/Drawable;B)V

    iput-object v0, p0, Landroid/support/v4/app/ActionBarDrawerToggle;->i:Landroid/support/v4/app/f;

    iget-object v1, p0, Landroid/support/v4/app/ActionBarDrawerToggle;->i:Landroid/support/v4/app/f;
    ...
    :goto_1
    invoke-virtual {v1, v0}, Landroid/support/v4/app/f;->setOffset(F)V
...
.method private a()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v4/app/ActionBarDrawerToggle;->c:Landroid/support/v4/media/routing/d;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/app/ActionBarDrawerToggle;->c:Landroid/support/v4/media/routing/d;

    invoke-interface {v0}, Landroid/support/v4/media/routing/d;->getThemeUpIndicator()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/app/b;->getThemeUpIndicator(Landroid/app/Activity;)Landroid/graphics/drawable/Drawable;
...
.method private a(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/routing/d;->setActionBarDescription(I)V
    ...
    invoke-interface {v0, v1, v2, p1}, Landroid/support/v4/app/b;->setActionBarDescription(Ljava/lang/Object;Landroid/app/Activity;I)Ljava/lang/Object;
...
.method private a(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/routing/d;->setActionBarUpIndicator(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-interface {v0, v1, v2, p1, p2}, Landroid/support/v4/app/b;->setActionBarUpIndicator(Ljava/lang/Object;Landroid/app/Activity;Landroid/graphics/drawable/Drawable;I)Ljava/lang/Object;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/content/e;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public onDrawerClosed(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/ActionBarDrawerToggle;->i:Landroid/support/v4/app/f;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroid/support/v4/app/f;->setPosition(F)V
...
.method public onDrawerSlide(Landroid/view/View;F)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/f;->getPosition()F
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/app/f;->setPosition(F)V
