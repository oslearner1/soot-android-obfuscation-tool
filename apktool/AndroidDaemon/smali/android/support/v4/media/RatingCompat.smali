...
.method public static fromRating(Ljava/lang/Object;)Landroid/support/v4/media/RatingCompat;
    ...
    :cond_1
    invoke-static {p0}, Landroid/support/v4/media/MediaBrowserCompat;->getRatingStyle(Ljava/lang/Object;)I

    move-result v1

    invoke-static {p0}, Landroid/support/v4/media/MediaBrowserCompat;->isRated(Ljava/lang/Object;)Z
    ...
    :pswitch_0
    invoke-static {p0}, Landroid/support/v4/media/MediaBrowserCompat;->hasHeart(Ljava/lang/Object;)Z
    ...
    :pswitch_1
    invoke-static {p0}, Landroid/support/v4/media/MediaBrowserCompat;->isThumbUp(Ljava/lang/Object;)Z
    ...
    :pswitch_2
    invoke-static {p0}, Landroid/support/v4/media/MediaBrowserCompat;->getStarRating(Ljava/lang/Object;)F
    ...
    :pswitch_3
    invoke-static {p0}, Landroid/support/v4/media/MediaBrowserCompat;->getPercentRating(Ljava/lang/Object;)F
...
.method public final getRating()Ljava/lang/Object;
    ...
    invoke-static {v0}, Landroid/support/v4/media/MediaBrowserCompat;->newHeartRating(Z)Ljava/lang/Object;
    ...
    invoke-static {v0}, Landroid/support/v4/media/MediaBrowserCompat;->newThumbRating(Z)Ljava/lang/Object;
    ...
    invoke-static {v0, v1}, Landroid/support/v4/media/MediaBrowserCompat;->newStarRating(IF)Ljava/lang/Object;
    ...
    invoke-static {v0}, Landroid/support/v4/media/MediaBrowserCompat;->newPercentageRating(F)Ljava/lang/Object;
    ...
    invoke-static {v0}, Landroid/support/v4/media/MediaBrowserCompat;->newUnratedRating(I)Ljava/lang/Object;
