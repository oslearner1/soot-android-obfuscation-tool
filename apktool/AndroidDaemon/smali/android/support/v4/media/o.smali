...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/o;->b:Landroid/support/v4/media/MediaBrowserServiceCompat;

    iput-object p2, p0, Landroid/support/v4/media/o;->a:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public final run()V
    ...
    iget-object v0, p0, Landroid/support/v4/media/o;->b:Landroid/support/v4/media/MediaBrowserServiceCompat;
    ...
    iget-object v1, p0, Landroid/support/v4/media/o;->b:Landroid/support/v4/media/MediaBrowserServiceCompat;
    ...
    check-cast v1, Landroid/support/v4/media/s;

    :try_start_0
    iget-object v3, v1, Landroid/support/v4/media/s;->b:Landroid/support/v4/media/IMediaBrowserServiceCompatCallbacks;

    iget-object v4, v1, Landroid/support/v4/media/s;->c:Lcom/vivo/vcalendar/component/VComponentBuilder;

    invoke-virtual {v4}, Lcom/vivo/vcalendar/component/VComponentBuilder;->getRootId()Ljava/lang/String;

    move-result-object v4

    iget-object v5, p0, Landroid/support/v4/media/o;->a:Landroid/support/v4/media/session/MediaSessionCompat$Token;

    iget-object v6, v1, Landroid/support/v4/media/s;->c:Lcom/vivo/vcalendar/component/VComponentBuilder;

    invoke-virtual {v6}, Lcom/vivo/vcalendar/component/VComponentBuilder;->getExtras()Landroid/os/Bundle;
    ...
    iget-object v1, v1, Landroid/support/v4/media/s;->a:Ljava/lang/String;
