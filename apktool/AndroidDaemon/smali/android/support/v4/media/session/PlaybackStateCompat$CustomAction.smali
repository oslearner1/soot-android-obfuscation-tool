...
.method static constructor <clinit>()V
    ...
    new-instance v0, Landroid/support/v4/media/session/ap;

    invoke-direct {v0}, Landroid/support/v4/media/session/ap;-><init>()V
...
.method synthetic constructor <init>(Ljava/lang/String;Ljava/lang/CharSequence;ILandroid/os/Bundle;B)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, p2, p3, v0}, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;ILandroid/os/Bundle;)V
...
.method public static fromCustomAction(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;
    ...
    invoke-static {p0}, Landroid/support/v4/media/session/h;->getAction(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p0}, Landroid/support/v4/media/session/h;->getName(Ljava/lang/Object;)Ljava/lang/CharSequence;

    move-result-object v2

    invoke-static {p0}, Landroid/support/v4/media/session/h;->getIcon(Ljava/lang/Object;)I

    move-result v3

    invoke-static {p0}, Landroid/support/v4/media/session/h;->getExtras(Ljava/lang/Object;)Landroid/os/Bundle;
...
.method public final getCustomAction()Ljava/lang/Object;
    ...
    invoke-static {v0, v1, v2, v3}, Landroid/support/v4/media/session/h;->newInstance(Ljava/lang/String;Ljava/lang/CharSequence;ILandroid/os/Bundle;)Ljava/lang/Object;
