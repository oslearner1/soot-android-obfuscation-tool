...
.method constructor <init>(Landroid/support/v4/media/u;Landroid/support/v4/media/IMediaBrowserServiceCompatCallbacks;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/x;->c:Landroid/support/v4/media/u;

    iput-object p2, p0, Landroid/support/v4/media/x;->a:Landroid/support/v4/media/IMediaBrowserServiceCompatCallbacks;
...
.method public final run()V
    ...
    iget-object v0, p0, Landroid/support/v4/media/x;->a:Landroid/support/v4/media/IMediaBrowserServiceCompatCallbacks;

    invoke-interface {v0}, Landroid/support/v4/media/IMediaBrowserServiceCompatCallbacks;->asBinder()Landroid/os/IBinder;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v4/media/x;->c:Landroid/support/v4/media/u;
    ...
    invoke-static {v1, v2, v0}, Landroid/support/v4/media/MediaBrowserServiceCompat;->a(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/String;Landroid/support/v4/media/s;)V
